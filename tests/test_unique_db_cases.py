...
class TestUniqueDBCases(unittest.TestCase):
	...
	def test_badatga_rr(self):
		self.run_test("바닷가", "{{ko-IPA|nobc=2}}", "badatga", "rr")
	def test_badatga_rrr(self):
		self.run_test("바닷가", "{{ko-IPA|nobc=2}}", "badasga", "rrr")
	def test_badatga_mr(self):
		self.run_test("바닷가", "{{ko-IPA|nobc=2}}", "padatka", "mr")
	...
	def test_ttwieonada_rr(self):
		self.run_test("뛰어나다", "{{ko-IPA|iot=2}}", "ttwieonada", "rr")
	def test_ttwieonada_rrr(self):
		self.run_test("뛰어나다", "{{ko-IPA|iot=2}}", "ttwieonada", "rrr")
	def test_ttwieonada_mr(self):
		self.run_test("뛰어나다", "{{ko-IPA|iot=2}}", "ttwiŏnada", "mr")
	def test_ttwieonada_yr(self):
		self.run_test("뛰어나다", "{{ko-IPA|iot=2}}", "ttwienata", "yr")
	def test_ttwieonada_ipa(self):
		self.run_test("뛰어나다", "{{ko-IPA|iot=2}}", "[t͈ɥiʌ̹na̠da̠] ~ [t͈ɥijʌ̹na̠da̠] ~ [t͈yʌ̹na̠da̠] ~ [t͈yjʌ̹na̠da̠]", "ipa")

	def test_geonmangjeung_ph(self):
		self.run_test("건망증", "{{ko-IPA|com=2|l=y}}", "건(ː)망쯩", "ph")
	def test_geonmangjeung_rr(self):
		self.run_test("건망증", "{{ko-IPA|com=2|l=y}}", "geonmangjeung", "rr")
	def test_geonmangjeung_rrr(self):
		self.run_test("건망증", "{{ko-IPA|com=2|l=y}}", "geonmangjeung", "rrr")
	def test_geonmangjeung_mr(self):
		self.run_test("건망증", "{{ko-IPA|com=2|l=y}}", "kŏnmangchŭng", "mr")
	def test_geonmangjeung_yr(self):
		self.run_test("건망증", "{{ko-IPA|com=2|l=y}}", "kēnmangqcung", "yr")
	def test_geonmangjeung_ipa(self):
		self.run_test("건망증", "{{ko-IPA|com=2|l=y}}", "[ˈkɘ(ː)nma̠ŋt͡ɕ͈ɯŋ]", "ipa")

	def test_Suragan_ph(self):
		self.run_test("수라간", "{{ko-IPA|com=2|cap=y}}", "수라깐", "ph")
	def test_Suragan_rr(self):
		self.run_test("수라간", "{{ko-IPA|com=2|cap=y}}", "Suragan", "rr")
	def test_Suragan_rrr(self):
		self.run_test("수라간", "{{ko-IPA|com=2|cap=y}}", "Sulagan", "rrr")
	def test_Suragan_mr(self):
		self.run_test("수라간", "{{ko-IPA|com=2|cap=y}}", "Surakan", "mr")
	def test_Suragan_yr(self):
		self.run_test("수라간", "{{ko-IPA|com=2|cap=y}}", "swulaqkan", "yr")
	def test_Suragan_ipa(self):
		self.run_test("수라간", "{{ko-IPA|com=2|cap=y}}", "[sʰuɾa̠k͈a̠n]", "ipa")

	def test_sasangui_jipyeongseon_ph(self):
		self.run_test("사상의 지평선", "{{ko-IPA|l=y|uie=3}}", "사(ː)상의 지평선/사(ː)상에 지평선", "ph")
	def test_sasangui_jipyeongseon_rr(self):
		self.run_test("사상의 지평선", "{{ko-IPA|l=y|uie=3}}", "sasang'ui jipyeongseon", "rr")
	def test_sasangui_jipyeongseon_rrr(self):
		self.run_test("사상의 지평선", "{{ko-IPA|l=y|uie=3}}", "sasang'ui jipyeongseon", "rrr")
	def test_sasangui_jipyeongseon_mr(self):
		self.run_test("사상의 지평선", "{{ko-IPA|l=y|uie=3}}", "sasangŭi chip'yŏngsŏn", "mr")
	def test_sasangui_jipyeongseon_yr(self):
		self.run_test("사상의 지평선", "{{ko-IPA|l=y|uie=3}}", "sāsanguy ci.phyengsen", "yr")
	...
	def test_Ijipteu_arap_gonghwaguk_rr(self):
		self.run_test("이집트 아랍 공화국", "{{ko-IPA|cap=y|l=8}}", "Ijipteu arap gonghwaguk", "rr")
	def test_Ijipteu_arap_gonghwaguk_rrr(self):
		self.run_test("이집트 아랍 공화국", "{{ko-IPA|cap=y|l=8}}", "Ijibteu alab gonghwagug", "rrr")
	def test_Ijipteu_arap_gonghwaguk_mr(self):
		self.run_test("이집트 아랍 공화국", "{{ko-IPA|cap=y|l=8}}", "Ijipt'ŭ arap konghwaguk", "mr")
	def test_Ijipteu_arap_gonghwaguk_yr(self):
		self.run_test("이집트 아랍 공화국", "{{ko-IPA|cap=y|l=8}}", "icipthu alap kōnghwakwuk", "yr")
	def test_Ijipteu_arap_gonghwaguk_ipa(self):
		self.run_test("이집트 아랍 공화국", "{{ko-IPA|cap=y|l=8}}", "[id͡ʑip̚tʰɯ a̠ɾa̠p̚ ko̞(ː)ŋβwa̠ɡuk̚]", "ipa")

	def test_kkamagwitgwa_ph(self):
		self.run_test("까마귓과", "{{ko-IPA|nobc=3}}", "까마귇꽈/까마귀꽈", "ph")
	def test_kkamagwitgwa_rr(self):
		self.run_test("까마귓과", "{{ko-IPA|nobc=3}}", "kkamagwitgwa", "rr")
	def test_kkamagwitgwa_rrr(self):
		self.run_test("까마귓과", "{{ko-IPA|nobc=3}}", "kkamagwisgwa", "rrr")
	def test_kkamagwitgwa_mr(self):
		self.run_test("까마귓과", "{{ko-IPA|nobc=3}}", "kkamagwitkwa", "mr")
	def test_kkamagwitgwa_yr(self):
		self.run_test("까마귓과", "{{ko-IPA|nobc=3}}", "kkamakwiskwa", "yr")
	def test_kkamagwitgwa_ipa(self):
		self.run_test("까마귓과", "{{ko-IPA|nobc=3}}", "[k͈a̠ma̠ɡɥit̚k͈wa̠] ~ [k͈a̠ma̠ɡɥik͈wa̠] ~ [k͈a̠ma̠ɡyt̚k͈wa̠] ~ [k͈a̠ma̠ɡyk͈wa̠]", "ipa")

	def test_Seonggyeong_ph(self):
		self.run_test("성경", "{{ko-IPA|cap=y|l=y}}", "성(ː)경", "ph")
	def test_Seonggyeong_rr(self):
		self.run_test("성경", "{{ko-IPA|cap=y|l=y}}", "Seonggyeong", "rr")
	def test_Seonggyeong_rrr(self):
		self.run_test("성경", "{{ko-IPA|cap=y|l=y}}", "Seonggyeong", "rrr")
	def test_Seonggyeong_mr(self):
		self.run_test("성경", "{{ko-IPA|cap=y|l=y}}", "Sŏnggyŏng", "mr")
	def test_Seonggyeong_yr(self):
		self.run_test("성경", "{{ko-IPA|cap=y|l=y}}", "sēngkyeng", "yr")
	def test_Seonggyeong_ipa(self):
		self.run_test("성경", "{{ko-IPA|cap=y|l=y}}", "[ˈsʰɘ(ː)ŋɡjʌ̹ŋ]", "ipa")

	def test_Taepyeongnyang_ph(self):
		self.run_test("태평양", "{{ko-IPA|cap=y|ni=3}}", "태평냥/테평냥", "ph")
	def test_Taepyeongnyang_rr(self):
		self.run_test("태평양", "{{ko-IPA|cap=y|ni=3}}", "Taepyeongnyang", "rr")
	def test_Taepyeongnyang_rrr(self):
		self.run_test("태평양", "{{ko-IPA|cap=y|ni=3}}", "Taepyeong'yang", "rrr")
	def test_Taepyeongnyang_mr(self):
		self.run_test("태평양", "{{ko-IPA|cap=y|ni=3}}", "T'aep'yŏngnyang", "mr")
	def test_Taepyeongnyang_yr(self):
		self.run_test("태평양", "{{ko-IPA|cap=y|ni=3}}", "thay.phyengnyang", "yr")
	...
	def test_keurim_rr(self):
		self.run_test("크림", "{{ko-IPA|l=2}}", "keurim", "rr")
	def test_keurim_rrr(self):
		self.run_test("크림", "{{ko-IPA|l=2}}", "keulim", "rrr")
	def test_keurim_mr(self):
		self.run_test("크림", "{{ko-IPA|l=2}}", "k'ŭrim", "mr")
	def test_keurim_yr(self):
		self.run_test("크림", "{{ko-IPA|l=2}}", "khulīm", "yr")
	def test_keurim_ipa(self):
		self.run_test("크림", "{{ko-IPA|l=2}}", "[kxɯɾi(ː)m]", "ipa")

	def test_simsannyugok_ph(self):
		self.run_test("심산유곡", "{{ko-IPA|l=y|ni=3}}", "심(ː)산뉴곡", "ph")
	def test_simsannyugok_rr(self):
		self.run_test("심산유곡", "{{ko-IPA|l=y|ni=3}}", "simsannyugok", "rr")
	def test_simsannyugok_rrr(self):
		self.run_test("심산유곡", "{{ko-IPA|l=y|ni=3}}", "simsan'yugog", "rrr")
	def test_simsannyugok_mr(self):
		self.run_test("심산유곡", "{{ko-IPA|l=y|ni=3}}", "simsannyugok", "mr")
	def test_simsannyugok_yr(self):
		self.run_test("심산유곡", "{{ko-IPA|l=y|ni=3}}", "sīmsannyukok", "yr")
	def test_simsannyugok_ipa(self):
		self.run_test("심산유곡", "{{ko-IPA|l=y|ni=3}}", "[ˈɕʰi(ː)msʰa̠nɲuɡo̞k̚]", "ipa")

	def test_maikeuropeuroseseo_ph(self):
		self.run_test("마이크로프로세서", "{{ko-IPA|com=6,7}}", "마이크로프로쎄써", "ph")
	def test_maikeuropeuroseseo_rr(self):
		self.run_test("마이크로프로세서", "{{ko-IPA|com=6,7}}", "maikeuropeuroseseo", "rr")
	def test_maikeuropeuroseseo_rrr(self):
		self.run_test("마이크로프로세서", "{{ko-IPA|com=6,7}}", "maikeulopeuloseseo", "rrr")
	def test_maikeuropeuroseseo_mr(self):
		self.run_test("마이크로프로세서", "{{ko-IPA|com=6,7}}", "maik'ŭrop'ŭrossessŏ", "mr")
	def test_maikeuropeuroseseo_yr(self):
		self.run_test("마이크로프로세서", "{{ko-IPA|com=6,7}}", "mai.khulo.phuloqseyqse", "yr")
	...
	def test_jat_rr(self):
		self.run_test("잣", "{{ko-IPA||l=y}}", "jat", "rr")
	def test_jat_rrr(self):
		self.run_test("잣", "{{ko-IPA||l=y}}", "jas", "rrr")
	def test_jat_mr(self):
		self.run_test("잣", "{{ko-IPA||l=y}}", "chat", "mr")
	def test_jat_yr(self):
		self.run_test("잣", "{{ko-IPA||l=y}}", "cās", "yr")
	...
	def test_seworeun_sarameul_gidaryeo_juji_anneunda_rr(self):
		self.run_test("세월은 사람을 기다려 주지 않는다", "{{ko-ipa|l=1,5}}", "seworeun sarameul gidaryeo juji anneunda", "rr")
	def test_seworeun_sarameul_gidaryeo_juji_anneunda_rrr(self):
		self.run_test("세월은 사람을 기다려 주지 않는다", "{{ko-ipa|l=1,5}}", "sewol'eun salam'eul gidalyeo juji anhneunda", "rrr")
	def test_seworeun_sarameul_gidaryeo_juji_anneunda_mr(self):
		self.run_test("세월은 사람을 기다려 주지 않는다", "{{ko-ipa|l=1,5}}", "sewŏrŭn saramŭl kidaryŏ chuji annŭnda", "mr")
	def test_seworeun_sarameul_gidaryeo_juji_anneunda_yr(self):
		self.run_test("세월은 사람을 기다려 주지 않는다", "{{ko-ipa|l=1,5}}", "sēywel.un sālam.ul kitalye cwuci anhnunta", "yr")
	def test_seworeun_sarameul_gidaryeo_juji_anneunda_ipa(self):
		self.run_test("세월은 사람을 기다려 주지 않는다", "{{ko-ipa|l=1,5}}", "[ˈsʰe̞(ː)wʌ̹ɾɯn sʰa̠(ː)ɾa̠mɯɭ kida̠ɾjʌ̹ t͡ɕud͡ʑi a̠nnɯnda̠]", "ipa")

	def test_dakgalbi_ph(self):
		self.run_test("닭갈비", "{{ko-IPA|bcred=1}}", "닥깔비", "ph")
	def test_dakgalbi_rr(self):
		self.run_test("닭갈비", "{{ko-IPA|bcred=1}}", "dakgalbi", "rr")
	def test_dakgalbi_rrr(self):
		self.run_test("닭갈비", "{{ko-IPA|bcred=1}}", "dalggalbi", "rrr")
	def test_dakgalbi_mr(self):
		self.run_test("닭갈비", "{{ko-IPA|bcred=1}}", "takkalbi", "mr")
	def test_dakgalbi_yr(self):
		self.run_test("닭갈비", "{{ko-IPA|bcred=1}}", "talk.kal.pi", "yr")
	def test_dakgalbi_ipa(self):
		self.run_test("닭갈비", "{{ko-IPA|bcred=1}}", "[ta̠k̚k͈a̠ɭbi]", "ipa")

	def test_namjonnyeobi_ph(self):
		self.run_test("남존여비", "{{ko-IPA|ni=3}}", "남존녀비", "ph")
	def test_namjonnyeobi_rr(self):
		self.run_test("남존여비", "{{ko-IPA|ni=3}}", "namjonnyeobi", "rr")
	def test_namjonnyeobi_rrr(self):
		self.run_test("남존여비", "{{ko-IPA|ni=3}}", "namjon'yeobi", "rrr")
	def test_namjonnyeobi_mr(self):
		self.run_test("남존여비", "{{ko-IPA|ni=3}}", "namjonnyŏbi", "mr")
	def test_namjonnyeobi_yr(self):
		self.run_test("남존여비", "{{ko-IPA|ni=3}}", "namconnyepi", "yr")
	def test_namjonnyeobi_ipa(self):
		self.run_test("남존여비", "{{ko-IPA|ni=3}}", "[na̠md͡ʑo̞nɲʌ̹bi]", "ipa")

	def test_Seuwiseu_ph(self):
		self.run_test("스위스", "{{ko-IPA|cap=y|com=2}}", "스위쓰", "ph")
	def test_Seuwiseu_rr(self):
		self.run_test("스위스", "{{ko-IPA|cap=y|com=2}}", "Seuwiseu", "rr")
	def test_Seuwiseu_rrr(self):
		self.run_test("스위스", "{{ko-IPA|cap=y|com=2}}", "Seuwiseu", "rrr")
	def test_Seuwiseu_mr(self):
		self.run_test("스위스", "{{ko-IPA|cap=y|com=2}}", "Sŭwissŭ", "mr")
	def test_Seuwiseu_yr(self):
		self.run_test("스위스", "{{ko-IPA|cap=y|com=2}}", "suwiqsu", "yr")
	...
	def test_Konggo_gonghwaguk_rr(self):
		self.run_test("콩고 공화국", "{{ko-IPA|cap=y|l=4}}", "Konggo gonghwaguk", "rr")
	def test_Konggo_gonghwaguk_rrr(self):
		self.run_test("콩고 공화국", "{{ko-IPA|cap=y|l=4}}", "Konggo gonghwagug", "rrr")
	def test_Konggo_gonghwaguk_mr(self):
		self.run_test("콩고 공화국", "{{ko-IPA|cap=y|l=4}}", "K'onggo konghwaguk", "mr")
	def test_Konggo_gonghwaguk_yr(self):
		self.run_test("콩고 공화국", "{{ko-IPA|cap=y|l=4}}", "khongko kōnghwakwuk", "yr")
	def test_Konggo_gonghwaguk_ipa(self):
		self.run_test("콩고 공화국", "{{ko-IPA|cap=y|l=4}}", "[kʰo̞ŋɡo̞ ko̞(ː)ŋβwa̠ɡuk̚]", "ipa")

	def test_Dominika_gonghwaguk_ph(self):
		self.run_test("도미니카 공화국", "{{ko-IPA|cap=y|l=6}}", "도미니카 공(ː)화국", "ph")
	def test_Dominika_gonghwaguk_rr(self):
		self.run_test("도미니카 공화국", "{{ko-IPA|cap=y|l=6}}", "Dominika gonghwaguk", "rr")
	def test_Dominika_gonghwaguk_rrr(self):
		self.run_test("도미니카 공화국", "{{ko-IPA|cap=y|l=6}}", "Dominika gonghwagug", "rrr")
	def test_Dominika_gonghwaguk_mr(self):
		self.run_test("도미니카 공화국", "{{ko-IPA|cap=y|l=6}}", "Tominik'a konghwaguk", "mr")
	def test_Dominika_gonghwaguk_yr(self):
		self.run_test("도미니카 공화국", "{{ko-IPA|cap=y|l=6}}", "tomini.kha kōnghwakwuk", "yr")
	def test_Dominika_gonghwaguk_ipa(self):
		self.run_test("도미니카 공화국", "{{ko-IPA|cap=y|l=6}}", "[to̞minikʰa̠ ko̞(ː)ŋβwa̠ɡuk̚]", "ipa")

	def test_allaguija_ph(self):
		self.run_test("안락의자", "{{ko-IPA|ui=3}}", "알라긔자/알라기자", "ph")
	def test_allaguija_rr(self):
		self.run_test("안락의자", "{{ko-IPA|ui=3}}", "allaguija", "rr")
	def test_allaguija_rrr(self):
		self.run_test("안락의자", "{{ko-IPA|ui=3}}", "anlag'uija", "rrr")
	def test_allaguija_mr(self):
		self.run_test("안락의자", "{{ko-IPA|ui=3}}", "allagŭija", "mr")
	def test_allaguija_yr(self):
		self.run_test("안락의자", "{{ko-IPA|ui=3}}", "anlak.uyca", "yr")
	def test_allaguija_ipa(self):
		self.run_test("안락의자", "{{ko-IPA|ui=3}}", "[a̠ɭɭa̠ɡɰid͡ʑa̠] ~ [a̠ɭɭa̠ɡid͡ʑa̠]", "ipa")

	def test_bakkadeoreun_ph(self):
		self.run_test("바깥어른", "{{ko-IPA|bcred=2}}", "바까더른", "ph")
	def test_bakkadeoreun_rr(self):
		self.run_test("바깥어른", "{{ko-IPA|bcred=2}}", "bakkadeoreun", "rr")
	def test_bakkadeoreun_rrr(self):
		self.run_test("바깥어른", "{{ko-IPA|bcred=2}}", "ba'kkat'eoleun", "rrr")
	def test_bakkadeoreun_mr(self):
		self.run_test("바깥어른", "{{ko-IPA|bcred=2}}", "pakkadŏrŭn", "mr")
	def test_bakkadeoreun_yr(self):
		self.run_test("바깥어른", "{{ko-IPA|bcred=2}}", "pa.kkath.elun", "yr")
	def test_bakkadeoreun_ipa(self):
		self.run_test("바깥어른", "{{ko-IPA|bcred=2}}", "[pa̠k͈a̠dʌ̹ɾɯn]", "ipa")

	def test_unjeon_myeonheojeung_ph(self):
		self.run_test("운전 면허증", "{{ko-IPA|l=y|com=5}}", "운(ː)전 면허쯩", "ph")
	def test_unjeon_myeonheojeung_rr(self):
		self.run_test("운전 면허증", "{{ko-IPA|l=y|com=5}}", "unjeon myeonheojeung", "rr")
	def test_unjeon_myeonheojeung_rrr(self):
		self.run_test("운전 면허증", "{{ko-IPA|l=y|com=5}}", "unjeon myeonheojeung", "rrr")
	def test_unjeon_myeonheojeung_mr(self):
		self.run_test("운전 면허증", "{{ko-IPA|l=y|com=5}}", "unjŏn myŏnhŏchŭng", "mr")
	def test_unjeon_myeonheojeung_yr(self):
		self.run_test("운전 면허증", "{{ko-IPA|l=y|com=5}}", "wūn.cen myen.heqcung", "yr")
	def test_unjeon_myeonheojeung_ipa(self):
		self.run_test("운전 면허증", "{{ko-IPA|l=y|com=5}}", "[ˈu(ː)ɲd͡ʑʌ̹n mjʌ̹nɦʌ̹t͡ɕ͈ɯŋ]", "ipa")

	def test_seongeullaseu_ph(self):
		self.run_test("선글라스", "{{ko-IPA|com=0,3}}", "썬글라쓰", "ph")
	def test_seongeullaseu_rr(self):
		self.run_test("선글라스", "{{ko-IPA|com=0,3}}", "seon'geullaseu", "rr")
	def test_seongeullaseu_rrr(self):
		self.run_test("선글라스", "{{ko-IPA|com=0,3}}", "seongeullaseu", "rrr")
	def test_seongeullaseu_mr(self):
		self.run_test("선글라스", "{{ko-IPA|com=0,3}}", "ssŏn'gŭllassŭ", "mr")
	def test_seongeullaseu_yr(self):
		self.run_test("선글라스", "{{ko-IPA|com=0,3}}", "qsenkullaqsu", "yr")
	def test_seongeullaseu_ipa(self):
		self.run_test("선글라스", "{{ko-IPA|com=0,3}}", "[s͈ʌ̹nɡɯɭɭa̠s͈ɯ]", "ipa")

	def test_nansenseu_ph(self):
		self.run_test("난센스", "{{ko-IPA|com=1,2}}", "난쎈쓰", "ph")
	def test_nansenseu_rr(self):
		self.run_test("난센스", "{{ko-IPA|com=1,2}}", "nansenseu", "rr")
	def test_nansenseu_rrr(self):
		self.run_test("난센스", "{{ko-IPA|com=1,2}}", "nansenseu", "rrr")
	def test_nansenseu_mr(self):
		self.run_test("난센스", "{{ko-IPA|com=1,2}}", "nanssenssŭ", "mr")
	def test_nansenseu_yr(self):
		self.run_test("난센스", "{{ko-IPA|com=1,2}}", "nanqseynqsu", "yr")
	def test_nansenseu_ipa(self):
		self.run_test("난센스", "{{ko-IPA|com=1,2}}", "[na̠ns͈e̞ns͈ɯ]", "ipa")

	def test_minibeoseu_ph(self):
		self.run_test("미니버스", "{{ko-IPA|com=2,3}}", "미니뻐쓰", "ph")
	def test_minibeoseu_rr(self):
		self.run_test("미니버스", "{{ko-IPA|com=2,3}}", "minibeoseu", "rr")
	def test_minibeoseu_rrr(self):
		self.run_test("미니버스", "{{ko-IPA|com=2,3}}", "minibeoseu", "rrr")
	def test_minibeoseu_mr(self):
		self.run_test("미니버스", "{{ko-IPA|com=2,3}}", "minipŏssŭ", "mr")
	def test_minibeoseu_yr(self):
		self.run_test("미니버스", "{{ko-IPA|com=2,3}}", "miniqpeqsu", "yr")
	def test_minibeoseu_ipa(self):
		self.run_test("미니버스", "{{ko-IPA|com=2,3}}", "[minip͈ʌ̹s͈ɯ]", "ipa")

	def test_onnain_ph(self):
		self.run_test("온라인", "{{ko-IPA|nn=2}}", "온나인", "ph")
	def test_onnain_rr(self):
		self.run_test("온라인", "{{ko-IPA|nn=2}}", "onnain", "rr")
	def test_onnain_rrr(self):
		self.run_test("온라인", "{{ko-IPA|nn=2}}", "onlain", "rrr")
	def test_onnain_mr(self):
		self.run_test("온라인", "{{ko-IPA|nn=2}}", "onnain", "mr")
	def test_onnain_yr(self):
		self.run_test("온라인", "{{ko-IPA|nn=2}}", "onlain", "yr")
	def test_onnain_ipa(self):
		self.run_test("온라인", "{{ko-IPA|nn=2}}", "[o̞nna̠in]", "ipa")

	def test_dambaetdae_ph(self):
		self.run_test("담뱃대", "{{ko-IPA|l=y|nobc=2}}", "담(ː)밷때/담(ː)배때/담(ː)벧떼/담(ː)베떼", "ph")
	def test_dambaetdae_rr(self):
		self.run_test("담뱃대", "{{ko-IPA|l=y|nobc=2}}", "dambaetdae", "rr")
	def test_dambaetdae_rrr(self):
		self.run_test("담뱃대", "{{ko-IPA|l=y|nobc=2}}", "dambaesdae", "rrr")
	def test_dambaetdae_mr(self):
		self.run_test("담뱃대", "{{ko-IPA|l=y|nobc=2}}", "tambaettae", "mr")
	def test_dambaetdae_yr(self):
		self.run_test("담뱃대", "{{ko-IPA|l=y|nobc=2}}", "tāmpaystay", "yr")
	def test_dambaetdae_ipa(self):
		self.run_test("담뱃대", "{{ko-IPA|l=y|nobc=2}}", "[ˈta̠(ː)mbɛt̚t͈ɛ] ~ [ˈta̠(ː)mbɛt͈ɛ] ~ [ˈta̠(ː)mbe̞t̚t͈e̞] ~ [ˈta̠(ː)mbe̞t͈e̞]", "ipa")

	def test_syuteukeiseu_ph(self):
		self.run_test("슈트케이스", "{{ko-IPA|com=4}}", "슈트케이쓰", "ph")
	def test_syuteukeiseu_rr(self):
		self.run_test("슈트케이스", "{{ko-IPA|com=4}}", "syuteukeiseu", "rr")
	def test_syuteukeiseu_rrr(self):
		self.run_test("슈트케이스", "{{ko-IPA|com=4}}", "syuteukeiseu", "rrr")
	def test_syuteukeiseu_mr(self):
		self.run_test("슈트케이스", "{{ko-IPA|com=4}}", "syut'ŭk'eissŭ", "mr")
	def test_syuteukeiseu_yr(self):
		self.run_test("슈트케이스", "{{ko-IPA|com=4}}", "syu.thu.kheyiqsu", "yr")
	def test_syuteukeiseu_ipa(self):
		self.run_test("슈트케이스", "{{ko-IPA|com=4}}", "[ɕʰutʰɯkʰe̞is͈ɯ]", "ipa")

	def test_mareukeuseujuui_ph(self):
		self.run_test("마르크스주의", "{{ko-IPA|ui=6}}", "마르크스주의/마르크스주이", "ph")
	def test_mareukeuseujuui_rr(self):
		self.run_test("마르크스주의", "{{ko-IPA|ui=6}}", "mareukeuseujuui", "rr")
	def test_mareukeuseujuui_rrr(self):
		self.run_test("마르크스주의", "{{ko-IPA|ui=6}}", "maleukeuseujuui", "rrr")
	def test_mareukeuseujuui_mr(self):
		self.run_test("마르크스주의", "{{ko-IPA|ui=6}}", "marŭk'ŭsŭjuŭi", "mr")
	def test_mareukeuseujuui_yr(self):
		self.run_test("마르크스주의", "{{ko-IPA|ui=6}}", "malu.khusucwuuy", "yr")
	def test_mareukeuseujuui_ipa(self):
		self.run_test("마르크스주의", "{{ko-IPA|ui=6}}", "[ma̠ɾɯkxɯsʰɯd͡ʑuɰi] ~ [ma̠ɾɯkxɯsʰɯd͡ʑui]", "ipa")

	def test_ttwieoneomda_ph(self):
		self.run_test("뛰어넘다", "{{ko-IPA|iot=2|com=3}}", "뛰어넘따/뛰여넘따", "ph")
	def test_ttwieoneomda_rr(self):
		self.run_test("뛰어넘다", "{{ko-IPA|iot=2|com=3}}", "ttwieoneomda", "rr")
	def test_ttwieoneomda_rrr(self):
		self.run_test("뛰어넘다", "{{ko-IPA|iot=2|com=3}}", "ttwieoneomda", "rrr")
	def test_ttwieoneomda_mr(self):
		self.run_test("뛰어넘다", "{{ko-IPA|iot=2|com=3}}", "ttwiŏnŏmta", "mr")
	def test_ttwieoneomda_yr(self):
		self.run_test("뛰어넘다", "{{ko-IPA|iot=2|com=3}}", "ttwienemqta", "yr")
	def test_ttwieoneomda_ipa(self):
		self.run_test("뛰어넘다", "{{ko-IPA|iot=2|com=3}}", "[t͈ɥiʌ̹nʌ̹mt͈a̠] ~ [t͈ɥijʌ̹nʌ̹mt͈a̠] ~ [t͈yʌ̹nʌ̹mt͈a̠] ~ [t͈yjʌ̹nʌ̹mt͈a̠]", "ipa")

	def test_jeongsik_ph(self):
		self.run_test("정식", "{{ko-IPA|l=1}}", "정(ː)식", "ph")
	def test_jeongsik_rr(self):
		self.run_test("정식", "{{ko-IPA|l=1}}", "jeongsik", "rr")
	def test_jeongsik_rrr(self):
		self.run_test("정식", "{{ko-IPA|l=1}}", "jeongsig", "rrr")
	def test_jeongsik_mr(self):
		self.run_test("정식", "{{ko-IPA|l=1}}", "chŏngsik", "mr")
	def test_jeongsik_yr(self):
		self.run_test("정식", "{{ko-IPA|l=1}}", "cēngsik", "yr")
	def test_jeongsik_ipa(self):
		self.run_test("정식", "{{ko-IPA|l=1}}", "[ˈt͡ɕɘ(ː)ŋɕʰik̚]", "ipa")

	def test_Sollomon_jedo_ph(self):
		self.run_test("솔로몬 제도", "{{ko-IPA|com=0|cap=y}}", "쏠로몬 제도", "ph")
	def test_Sollomon_jedo_rr(self):
		self.run_test("솔로몬 제도", "{{ko-IPA|com=0|cap=y}}", "Sollomon jedo", "rr")
	def test_Sollomon_jedo_rrr(self):
		self.run_test("솔로몬 제도", "{{ko-IPA|com=0|cap=y}}", "Sollomon jedo", "rrr")
	def test_Sollomon_jedo_mr(self):
		self.run_test("솔로몬 제도", "{{ko-IPA|com=0|cap=y}}", "Ssollomon chedo", "mr")
	def test_Sollomon_jedo_yr(self):
		self.run_test("솔로몬 제도", "{{ko-IPA|com=0|cap=y}}", "qsollomon ceyto", "yr")
	def test_Sollomon_jedo_ipa(self):
		self.run_test("솔로몬 제도", "{{ko-IPA|com=0|cap=y}}", "[s͈o̞ɭɭo̞mo̞n t͡ɕe̞do̞]", "ipa")

	def test_gyoui_ph(self):
		self.run_test("교의", "{{ko-IPA|ui=2|l=y}}", "교(ː)의/교(ː)이", "ph")
	def test_gyoui_rr(self):
		self.run_test("교의", "{{ko-IPA|ui=2|l=y}}", "gyoui", "rr")
	def test_gyoui_rrr(self):
		self.run_test("교의", "{{ko-IPA|ui=2|l=y}}", "gyoui", "rrr")
	def test_gyoui_mr(self):
		self.run_test("교의", "{{ko-IPA|ui=2|l=y}}", "kyoŭi", "mr")
	def test_gyoui_yr(self):
		self.run_test("교의", "{{ko-IPA|ui=2|l=y}}", "kyōuy", "yr")
	def test_gyoui_ipa(self):
		self.run_test("교의", "{{ko-IPA|ui=2|l=y}}", "[ˈkjo(ː)ɰi] ~ [ˈkjo(ː)i]", "ipa")

	def test_Buhwaljeol_ph(self):
		self.run_test("부활절", "{{ko-IPA|l=y|com=2|cap=y}}", "부(ː)활쩔", "ph")
	def test_Buhwaljeol_rr(self):
		self.run_test("부활절", "{{ko-IPA|l=y|com=2|cap=y}}", "Buhwaljeol", "rr")
	def test_Buhwaljeol_rrr(self):
		self.run_test("부활절", "{{ko-IPA|l=y|com=2|cap=y}}", "Buhwaljeol", "rrr")
	def test_Buhwaljeol_mr(self):
		self.run_test("부활절", "{{ko-IPA|l=y|com=2|cap=y}}", "Puhwalchŏl", "mr")
	def test_Buhwaljeol_yr(self):
		self.run_test("부활절", "{{ko-IPA|l=y|com=2|cap=y}}", "pūhwalqcel", "yr")
	def test_Buhwaljeol_ipa(self):
		self.run_test("부활절", "{{ko-IPA|l=y|com=2|cap=y}}", "[ˈpu(ː)βwa̠ʎt͡ɕ͈ʌ̹ɭ]", "ipa")

	def test_wennil_ph(self):
		self.run_test("웬일", "{{ko-IPA|l=y|ni=2}}", "웬(ː)닐", "ph")
	def test_wennil_rr(self):
		self.run_test("웬일", "{{ko-IPA|l=y|ni=2}}", "wennil", "rr")
	def test_wennil_rrr(self):
		self.run_test("웬일", "{{ko-IPA|l=y|ni=2}}", "wen'il", "rrr")
	def test_wennil_mr(self):
		self.run_test("웬일", "{{ko-IPA|l=y|ni=2}}", "wennil", "mr")
	def test_wennil_yr(self):
		self.run_test("웬일", "{{ko-IPA|l=y|ni=2}}", "wēynnil", "yr")
	def test_wennil_ipa(self):
		self.run_test("웬일", "{{ko-IPA|l=y|ni=2}}", "[ˈwe̞(ː)nniɭ]", "ipa")

	def test_Sinuiju_ph(self):
		self.run_test("신의주", "{{ko-IPA|cap=y|ui=2}}", "시늬주/시니주", "ph")
	def test_Sinuiju_rr(self):
		self.run_test("신의주", "{{ko-IPA|cap=y|ui=2}}", "Sinuiju", "rr")
	def test_Sinuiju_rrr(self):
		self.run_test("신의주", "{{ko-IPA|cap=y|ui=2}}", "Sin'uiju", "rrr")
	def test_Sinuiju_mr(self):
		self.run_test("신의주", "{{ko-IPA|cap=y|ui=2}}", "Sinŭiju", "mr")
	...
	def test_Sollomonui_jihye_rr(self):
		self.run_test("솔로몬의 지혜", "{{ko-IPA|cap=y|uie=4}}", "Sollomonui jihye", "rr")
	def test_Sollomonui_jihye_rrr(self):
		self.run_test("솔로몬의 지혜", "{{ko-IPA|cap=y|uie=4}}", "Sollomon'ui jihye", "rrr")
	def test_Sollomonui_jihye_mr(self):
		self.run_test("솔로몬의 지혜", "{{ko-IPA|cap=y|uie=4}}", "Sollomonŭi chihye", "mr")
	def test_Sollomonui_jihye_yr(self):
		self.run_test("솔로몬의 지혜", "{{ko-IPA|cap=y|uie=4}}", "sollomon.uy cihyey", "yr")
	...
	def test_Reunesangseu_rr(self):
		self.run_test("르네상스", "{{ko-IPA|cap=y|com=2,3}}", "Reunesangseu", "rr")
	def test_Reunesangseu_rrr(self):
		self.run_test("르네상스", "{{ko-IPA|cap=y|com=2,3}}", "Leunesangseu", "rrr")
	def test_Reunesangseu_mr(self):
		self.run_test("르네상스", "{{ko-IPA|cap=y|com=2,3}}", "Rŭnessangssŭ", "mr")
	def test_Reunesangseu_yr(self):
		self.run_test("르네상스", "{{ko-IPA|cap=y|com=2,3}}", "luneyqsangqsu", "yr")
	def test_Reunesangseu_ipa(self):
		self.run_test("르네상스", "{{ko-IPA|cap=y|com=2,3}}", "[ɾɯne̞s͈a̠ŋs͈ɯ]", "ipa")

	def test_kong_simeun_de_kong_nago_pat_simeun_de_pat_nanda_ph(self):
		self.run_test("콩 심은 데 콩 나고 팥 심은 데 팥 난다", "{{ko-IPA|l=3,15}}", "콩 시(ː)믄 데 콩 나고 팓 시(ː)믄 데 팓 난다", "ph")
	def test_kong_simeun_de_kong_nago_pat_simeun_de_pat_nanda_rr(self):
		self.run_test("콩 심은 데 콩 나고 팥 심은 데 팥 난다", "{{ko-IPA|l=3,15}}", "kong simeun de kong nago pat simeun de pat nanda", "rr")
	def test_kong_simeun_de_kong_nago_pat_simeun_de_pat_nanda_rrr(self):
		self.run_test("콩 심은 데 콩 나고 팥 심은 데 팥 난다", "{{ko-IPA|l=3,15}}", "kong sim'eun de kong nago pat sim'eun de pat nanda", "rrr")
	def test_kong_simeun_de_kong_nago_pat_simeun_de_pat_nanda_mr(self):
		self.run_test("콩 심은 데 콩 나고 팥 심은 데 팥 난다", "{{ko-IPA|l=3,15}}", "k'ong simŭn te k'ong nago p'at simŭn te p'at nanda", "mr")
	def test_kong_simeun_de_kong_nago_pat_simeun_de_pat_nanda_yr(self):
		self.run_test("콩 심은 데 콩 나고 팥 심은 데 팥 난다", "{{ko-IPA|l=3,15}}", "khong sīm.un tey khong nako phath sīm.un tey phath nanta", "yr")
	def test_kong_simeun_de_kong_nago_pat_simeun_de_pat_nanda_ipa(self):
		self.run_test("콩 심은 데 콩 나고 팥 심은 데 팥 난다", "{{ko-IPA|l=3,15}}", "[kʰo̞ŋ ɕʰi(ː)mɯn te̞ kʰo̞ŋ na̠ɡo̞ pʰa̠t̚ ɕʰi(ː)mɯn te̞ pʰa̠t̚ na̠nda̠]", "ipa")

	def test_selpeu_diseu_ph(self):
		self.run_test("셀프 디스", "{{ko-IPA|com=0,4}}", "쎌프 디쓰", "ph")
	def test_selpeu_diseu_rr(self):
		self.run_test("셀프 디스", "{{ko-IPA|com=0,4}}", "selpeu diseu", "rr")
	def test_selpeu_diseu_rrr(self):
		self.run_test("셀프 디스", "{{ko-IPA|com=0,4}}", "selpeu diseu", "rrr")
	def test_selpeu_diseu_mr(self):
		self.run_test("셀프 디스", "{{ko-IPA|com=0,4}}", "sselp'ŭ tissŭ", "mr")
	def test_selpeu_diseu_yr(self):
		self.run_test("셀프 디스", "{{ko-IPA|com=0,4}}", "qseyl.phu tiqsu", "yr")
	...
	def test_Geuriseudoui_jeok_rr(self):
		self.run_test("그리스도의 적", "{{ko-IPA|cap=y|uie=5}}", "Geuriseudoui jeok", "rr")
	def test_Geuriseudoui_jeok_rrr(self):
		self.run_test("그리스도의 적", "{{ko-IPA|cap=y|uie=5}}", "Geuliseudoui jeog", "rrr")
	def test_Geuriseudoui_jeok_mr(self):
		self.run_test("그리스도의 적", "{{ko-IPA|cap=y|uie=5}}", "Kŭrisŭdoŭi chŏk", "mr")
	def test_Geuriseudoui_jeok_yr(self):
		self.run_test("그리스도의 적", "{{ko-IPA|cap=y|uie=5}}", "kulisutouy cek", "yr")
	def test_Geuriseudoui_jeok_ipa(self):
		self.run_test("그리스도의 적", "{{ko-IPA|cap=y|uie=5}}", "[kɯɾisʰɯdo̞ɰi t͡ɕʌ̹k̚] ~ [kɯɾisʰɯdo̞e̞ t͡ɕʌ̹k̚]", "ipa")

	def test_geondal_ph(self):
		self.run_test("건달", "{{ko-IPA|l=}}", "건달", "ph")
	def test_geondal_rr(self):
		self.run_test("건달", "{{ko-IPA|l=}}", "geondal", "rr")
	def test_geondal_rrr(self):
		self.run_test("건달", "{{ko-IPA|l=}}", "geondal", "rrr")
	def test_geondal_mr(self):
		self.run_test("건달", "{{ko-IPA|l=}}", "kŏndal", "mr")
	def test_geondal_yr(self):
		self.run_test("건달", "{{ko-IPA|l=}}", "kental", "yr")
	def test_geondal_ipa(self):
		self.run_test("건달", "{{ko-IPA|l=}}", "[kʌ̹nda̠ɭ]", "ipa")

	def test_geurimui_tteok_ph(self):
		self.run_test("그림의 떡", "{{ko-IPA|uie=3|l=y}}", "그(ː)리믜 떡/그(ː)리메 떡", "ph")
	def test_geurimui_tteok_rr(self):
		self.run_test("그림의 떡", "{{ko-IPA|uie=3|l=y}}", "geurimui tteok", "rr")
	def test_geurimui_tteok_rrr(self):
		self.run_test("그림의 떡", "{{ko-IPA|uie=3|l=y}}", "geulim'ui tteog", "rrr")
	def test_geurimui_tteok_mr(self):
		self.run_test("그림의 떡", "{{ko-IPA|uie=3|l=y}}", "kŭrimŭi ttŏk", "mr")
	def test_geurimui_tteok_yr(self):
		self.run_test("그림의 떡", "{{ko-IPA|uie=3|l=y}}", "kūlim.uy ttek", "yr")
	def test_geurimui_tteok_ipa(self):
		self.run_test("그림의 떡", "{{ko-IPA|uie=3|l=y}}", "[ˈkɯ(ː)ɾimɰi t͈ʌ̹k̚] ~ [ˈkɯ(ː)ɾime̞ t͈ʌ̹k̚]", "ipa")

	def test_namapeurikaui_oechim_ph(self):
		self.run_test("남아프리카의 외침", "{{ko-IPA|uie=6}}", "나마프리카의 웨침/나마프리카의 웨침/나마프리카의 외침/나마프리카에 외침", "ph")
	def test_namapeurikaui_oechim_rr(self):
		self.run_test("남아프리카의 외침", "{{ko-IPA|uie=6}}", "namapeurikaui oechim", "rr")
	def test_namapeurikaui_oechim_rrr(self):
		self.run_test("남아프리카의 외침", "{{ko-IPA|uie=6}}", "nam'apeulikaui oechim", "rrr")
	def test_namapeurikaui_oechim_mr(self):
		self.run_test("남아프리카의 외침", "{{ko-IPA|uie=6}}", "namap'ŭrik'aŭi oech'im", "mr")
	def test_namapeurikaui_oechim_yr(self):
		self.run_test("남아프리카의 외침", "{{ko-IPA|uie=6}}", "nam.a.phuli.khauy oy.chim", "yr")
	def test_namapeurikaui_oechim_ipa(self):
		self.run_test("남아프리카의 외침", "{{ko-IPA|uie=6}}", "[na̠ma̠pʰɯɾikʰa̠ɰi we̞t͡ɕʰim] ~ [na̠ma̠pʰɯɾikʰa̠ɰi we̞t͡ɕʰim] ~ [na̠ma̠pʰɯɾikʰa̠ɰi ø̞t͡ɕʰim] ~ [na̠ma̠pʰɯɾikʰa̠e̞ ø̞t͡ɕʰim]", "ipa")

	def test_bansinbanin_ph(self):
		self.run_test("반신반인", "{{ko-IPA|l=1,3}}", "반(ː)신바(ː)닌", "ph")
	def test_bansinbanin_rr(self):
		self.run_test("반신반인", "{{ko-IPA|l=1,3}}", "bansinbanin", "rr")
	def test_bansinbanin_rrr(self):
		self.run_test("반신반인", "{{ko-IPA|l=1,3}}", "bansinban'in", "rrr")
	def test_bansinbanin_mr(self):
		self.run_test("반신반인", "{{ko-IPA|l=1,3}}", "pansinbanin", "mr")
	def test_bansinbanin_yr(self):
		self.run_test("반신반인", "{{ko-IPA|l=1,3}}", "pānsinpān.in", "yr")
	def test_bansinbanin_ipa(self):
		self.run_test("반신반인", "{{ko-IPA|l=1,3}}", "[ˈpa̠(ː)nɕʰinba̠(ː)nin]", "ipa")

	def test_chulsannyul_ph(self):
		self.run_test("출산율", "{{ko-IPA|com=1|ni=3}}", "출싼뉼", "ph")
	def test_chulsannyul_rr(self):
		self.run_test("출산율", "{{ko-IPA|com=1|ni=3}}", "chulsannyul", "rr")
	def test_chulsannyul_rrr(self):
		self.run_test("출산율", "{{ko-IPA|com=1|ni=3}}", "chulsan'yul", "rrr")
	def test_chulsannyul_mr(self):
		self.run_test("출산율", "{{ko-IPA|com=1|ni=3}}", "ch'ulssannyul", "mr")
	def test_chulsannyul_yr(self):
		self.run_test("출산율", "{{ko-IPA|com=1|ni=3}}", "chwulqsannyul", "yr")
	def test_chulsannyul_ipa(self):
		self.run_test("출산율", "{{ko-IPA|com=1|ni=3}}", "[t͡ɕʰuɭs͈a̠nɲuɭ]", "ipa")

	def test_koronabaireoseu_ph(self):
		self.run_test("코로나바이러스", "{{ko-IPA|com=6}}", "코로나바이러쓰", "ph")
	def test_koronabaireoseu_rr(self):
		self.run_test("코로나바이러스", "{{ko-IPA|com=6}}", "koronabaireoseu", "rr")
	def test_koronabaireoseu_rrr(self):
		self.run_test("코로나바이러스", "{{ko-IPA|com=6}}", "kolonabaileoseu", "rrr")
	def test_koronabaireoseu_mr(self):
		self.run_test("코로나바이러스", "{{ko-IPA|com=6}}", "k'oronabairŏssŭ", "mr")
	def test_koronabaireoseu_yr(self):
		self.run_test("코로나바이러스", "{{ko-IPA|com=6}}", "kholonapaileqsu", "yr")
	def test_koronabaireoseu_ipa(self):
		self.run_test("코로나바이러스", "{{ko-IPA|com=6}}", "[kʰo̞ɾo̞na̠ba̠iɾʌ̹s͈ɯ]", "ipa")

	def test_mujeongbujuui_ph(self):
		self.run_test("무정부주의", "{{ko-IPA|ui=5}}", "무정부주의/무정부주이", "ph")
	def test_mujeongbujuui_rr(self):
		self.run_test("무정부주의", "{{ko-IPA|ui=5}}", "mujeongbujuui", "rr")
	def test_mujeongbujuui_rrr(self):
		self.run_test("무정부주의", "{{ko-IPA|ui=5}}", "mujeongbujuui", "rrr")
	def test_mujeongbujuui_mr(self):
		self.run_test("무정부주의", "{{ko-IPA|ui=5}}", "mujŏngbujuŭi", "mr")
	def test_mujeongbujuui_yr(self):
		self.run_test("무정부주의", "{{ko-IPA|ui=5}}", "mucengpucwuuy", "yr")
	def test_mujeongbujuui_ipa(self):
		self.run_test("무정부주의", "{{ko-IPA|ui=5}}", "[mud͡ʑʌ̹ŋbud͡ʑuɰi] ~ [mud͡ʑʌ̹ŋbud͡ʑui]", "ipa")

	def test_Paldo_ph(self):
		self.run_test("팔도", "{{ko-IPA|com=1|cap=y}}", "팔또", "ph")
	def test_Paldo_rr(self):
		self.run_test("팔도", "{{ko-IPA|com=1|cap=y}}", "Paldo", "rr")
	def test_Paldo_rrr(self):
		self.run_test("팔도", "{{ko-IPA|com=1|cap=y}}", "Paldo", "rrr")
	def test_Paldo_mr(self):
		self.run_test("팔도", "{{ko-IPA|com=1|cap=y}}", "P'alto", "mr")
	def test_Paldo_yr(self):
		self.run_test("팔도", "{{ko-IPA|com=1|cap=y}}", "phalqto", "yr")
	def test_Paldo_ipa(self):
		self.run_test("팔도", "{{ko-IPA|com=1|cap=y}}", "[pʰa̠ɭt͈o̞]", "ipa")

	def test_naetga_ph(self):
		self.run_test("냇가", "{{ko-IPA|nobc=1|l=y}}", "낻(ː)까/내(ː)까/넫(ː)까/네(ː)까", "ph")
	def test_naetga_rr(self):
		self.run_test("냇가", "{{ko-IPA|nobc=1|l=y}}", "naetga", "rr")
	def test_naetga_rrr(self):
		self.run_test("냇가", "{{ko-IPA|nobc=1|l=y}}", "naesga", "rrr")
	def test_naetga_mr(self):
		self.run_test("냇가", "{{ko-IPA|nobc=1|l=y}}", "naetka", "mr")
	def test_naetga_yr(self):
		self.run_test("냇가", "{{ko-IPA|nobc=1|l=y}}", "nāyska", "yr")
	def test_naetga_ipa(self):
		self.run_test("냇가", "{{ko-IPA|nobc=1|l=y}}", "[ˈnɛ(ː)t̚k͈a̠] ~ [ˈnɛ(ː)k͈a̠] ~ [ˈne̞(ː)t̚k͈a̠] ~ [ˈne̞(ː)k͈a̠]", "ipa")

	def test_jiseongimyeon_gamcheonida_ph(self):
		self.run_test("지성이면 감천이다", "{{ko-IPA|l=6}}", "지성이면 감(ː)처니다", "ph")
	def test_jiseongimyeon_gamcheonida_rr(self):
		self.run_test("지성이면 감천이다", "{{ko-IPA|l=6}}", "jiseong'imyeon gamcheonida", "rr")
	def test_jiseongimyeon_gamcheonida_rrr(self):
		self.run_test("지성이면 감천이다", "{{ko-IPA|l=6}}", "jiseong'imyeon gamcheon'ida", "rrr")
	def test_jiseongimyeon_gamcheonida_mr(self):
		self.run_test("지성이면 감천이다", "{{ko-IPA|l=6}}", "chisŏngimyŏn kamch'ŏnida", "mr")
	def test_jiseongimyeon_gamcheonida_yr(self):
		self.run_test("지성이면 감천이다", "{{ko-IPA|l=6}}", "cisengimyen kāmchen.ita", "yr")
	def test_jiseongimyeon_gamcheonida_ipa(self):
		self.run_test("지성이면 감천이다", "{{ko-IPA|l=6}}", "[t͡ɕisʰʌ̹ŋimjʌ̹n ka̠(ː)mt͡ɕʰʌ̹nida̠]", "ipa")

	def test_saengsallyeotalgwon_ph(self):
		self.run_test("생살여탈권", "{{ko-IPA|ni=3|com=4}}", "생살려탈꿘/셍살려탈꿘", "ph")
	def test_saengsallyeotalgwon_rr(self):
		self.run_test("생살여탈권", "{{ko-IPA|ni=3|com=4}}", "saengsallyeotalgwon", "rr")
	def test_saengsallyeotalgwon_rrr(self):
		self.run_test("생살여탈권", "{{ko-IPA|ni=3|com=4}}", "saengsal'yeotalgwon", "rrr")
	def test_saengsallyeotalgwon_mr(self):
		self.run_test("생살여탈권", "{{ko-IPA|ni=3|com=4}}", "saengsallyŏt'alkwŏn", "mr")
	def test_saengsallyeotalgwon_yr(self):
		self.run_test("생살여탈권", "{{ko-IPA|ni=3|com=4}}", "sayngsallye.thalqkwen", "yr")
	def test_saengsallyeotalgwon_ipa(self):
		self.run_test("생살여탈권", "{{ko-IPA|ni=3|com=4}}", "[sʰɛŋsʰa̠ʎʎʌ̹tʰa̠ɭk͈wʌ̹n] ~ [sʰe̞ŋsʰa̠ʎʎʌ̹tʰa̠ɭk͈wʌ̹n]", "ipa")

	def test_mije_sageon_ph(self):
		self.run_test("미제 사건", "{{ko-IPA|l=1,4|com=4}}", "미(ː)제 사(ː)껀", "ph")
	def test_mije_sageon_rr(self):
		self.run_test("미제 사건", "{{ko-IPA|l=1,4|com=4}}", "mije sageon", "rr")
	def test_mije_sageon_rrr(self):
		self.run_test("미제 사건", "{{ko-IPA|l=1,4|com=4}}", "mije sageon", "rrr")
	def test_mije_sageon_mr(self):
		self.run_test("미제 사건", "{{ko-IPA|l=1,4|com=4}}", "mije sakŏn", "mr")
	def test_mije_sageon_yr(self):
		self.run_test("미제 사건", "{{ko-IPA|l=1,4|com=4}}", "mīcey sāqken", "yr")
	...
	def test_onsil_sogui_hwacho_rr(self):
		self.run_test("온실 속의 화초", "{{ko-IPA|uie=5}}", "onsil sogui hwacho", "rr")
	def test_onsil_sogui_hwacho_rrr(self):
		self.run_test("온실 속의 화초", "{{ko-IPA|uie=5}}", "onsil sog'ui hwacho", "rrr")
	def test_onsil_sogui_hwacho_mr(self):
		self.run_test("온실 속의 화초", "{{ko-IPA|uie=5}}", "onsil sogŭi hwach'o", "mr")
	def test_onsil_sogui_hwacho_yr(self):
		self.run_test("온실 속의 화초", "{{ko-IPA|uie=5}}", "onsil sok.uy hwa.cho", "yr")
	def test_onsil_sogui_hwacho_ipa(self):
		self.run_test("온실 속의 화초", "{{ko-IPA|uie=5}}", "[o̞nɕʰiɭ sʰo̞ɡɰi ɸwa̠t͡ɕʰo̞] ~ [o̞nɕʰiɭ sʰo̞ɡe̞ ɸwa̠t͡ɕʰo̞]", "ipa")

	def test_siljonjuui_ph(self):
		self.run_test("실존주의", "{{ko-IPA|com=1|ui=4}}", "실쫀주의/실쫀주이", "ph")
	def test_siljonjuui_rr(self):
		self.run_test("실존주의", "{{ko-IPA|com=1|ui=4}}", "siljonjuui", "rr")
	def test_siljonjuui_rrr(self):
		self.run_test("실존주의", "{{ko-IPA|com=1|ui=4}}", "siljonjuui", "rrr")
	def test_siljonjuui_mr(self):
		self.run_test("실존주의", "{{ko-IPA|com=1|ui=4}}", "silchonjuŭi", "mr")
	def test_siljonjuui_yr(self):
		self.run_test("실존주의", "{{ko-IPA|com=1|ui=4}}", "silqcon.cwuuy", "yr")
	def test_siljonjuui_ipa(self):
		self.run_test("실존주의", "{{ko-IPA|com=1|ui=4}}", "[ɕʰiʎt͡ɕ͈o̞ɲd͡ʑuɰi] ~ [ɕʰiʎt͡ɕ͈o̞ɲd͡ʑui]", "ipa")

	def test_seonmudangi_saram_jamneunda_ph(self):
		self.run_test("선무당이 사람 잡는다", "{{ko-IPA|l=1,6}}", "선(ː)무당이 사(ː)람 잠는다", "ph")
	def test_seonmudangi_saram_jamneunda_rr(self):
		self.run_test("선무당이 사람 잡는다", "{{ko-IPA|l=1,6}}", "seonmudang'i saram jamneunda", "rr")
	def test_seonmudangi_saram_jamneunda_rrr(self):
		self.run_test("선무당이 사람 잡는다", "{{ko-IPA|l=1,6}}", "seonmudang'i salam jabneunda", "rrr")
	def test_seonmudangi_saram_jamneunda_mr(self):
		self.run_test("선무당이 사람 잡는다", "{{ko-IPA|l=1,6}}", "sŏnmudangi saram chamnŭnda", "mr")
	def test_seonmudangi_saram_jamneunda_yr(self):
		self.run_test("선무당이 사람 잡는다", "{{ko-IPA|l=1,6}}", "sēnmutangi sālam capnunta", "yr")
	def test_seonmudangi_saram_jamneunda_ipa(self):
		self.run_test("선무당이 사람 잡는다", "{{ko-IPA|l=1,6}}", "[ˈsʰɘ(ː)nmuda̠ŋi sʰa̠(ː)ɾa̠m t͡ɕa̠mnɯnda̠]", "ipa")

	def test_Nikollaseu_ph(self):
		self.run_test("니콜라스", "{{ko-IPA|cap=y|com=3}}", "니콜라쓰", "ph")
	def test_Nikollaseu_rr(self):
		self.run_test("니콜라스", "{{ko-IPA|cap=y|com=3}}", "Nikollaseu", "rr")
	def test_Nikollaseu_rrr(self):
		self.run_test("니콜라스", "{{ko-IPA|cap=y|com=3}}", "Nikollaseu", "rrr")
	def test_Nikollaseu_mr(self):
		self.run_test("니콜라스", "{{ko-IPA|cap=y|com=3}}", "Nik'ollassŭ", "mr")
	def test_Nikollaseu_yr(self):
		self.run_test("니콜라스", "{{ko-IPA|cap=y|com=3}}", "ni.khollaqsu", "yr")
	...
	def test_sarangui_mae_rr(self):
		self.run_test("사랑의 매", "{{ko-IPA|uie=3}}", "sarang'ui mae", "rr")
	def test_sarangui_mae_rrr(self):
		self.run_test("사랑의 매", "{{ko-IPA|uie=3}}", "salang'ui mae", "rrr")
	def test_sarangui_mae_mr(self):
		self.run_test("사랑의 매", "{{ko-IPA|uie=3}}", "sarangŭi mae", "mr")
	def test_sarangui_mae_yr(self):
		self.run_test("사랑의 매", "{{ko-IPA|uie=3}}", "salanguy may", "yr")
	...
	def test_Ellijabeseu_rr(self):
		self.run_test("엘리자베스", "{{ko-IPA|cap=y|com=5}}", "Ellijabeseu", "rr")
	def test_Ellijabeseu_rrr(self):
		self.run_test("엘리자베스", "{{ko-IPA|cap=y|com=5}}", "Ellijabeseu", "rrr")
	def test_Ellijabeseu_mr(self):
		self.run_test("엘리자베스", "{{ko-IPA|cap=y|com=5}}", "Ellijabesŭ", "mr")
	def test_Ellijabeseu_yr(self):
		self.run_test("엘리자베스", "{{ko-IPA|cap=y|com=5}}", "eyllicapeysu", "yr")
	def test_Ellijabeseu_ipa(self):
		self.run_test("엘리자베스", "{{ko-IPA|cap=y|com=5}}", "[e̞ʎʎid͡ʑa̠be̞sʰɯ]", "ipa")

	def test_ingicheok_ph(self):
		self.run_test("인기척", "{{ko-IPA||com=1}}", "인끼척", "ph")
	def test_ingicheok_rr(self):
		self.run_test("인기척", "{{ko-IPA||com=1}}", "in'gicheok", "rr")
	def test_ingicheok_rrr(self):
		self.run_test("인기척", "{{ko-IPA||com=1}}", "ingicheog", "rrr")
	def test_ingicheok_mr(self):
		self.run_test("인기척", "{{ko-IPA||com=1}}", "inkich'ŏk", "mr")
	def test_ingicheok_yr(self):
		self.run_test("인기척", "{{ko-IPA||com=1}}", "inqki.chek", "yr")
	def test_ingicheok_ipa(self):
		self.run_test("인기척", "{{ko-IPA||com=1}}", "[ink͈it͡ɕʰʌ̹k̚]", "ipa")

	def test_Cheorui_jangmak_ph(self):
		self.run_test("철의 장막", "{{ko-IPA|cap=y|uie=2}}", "처릐 장막/처레 장막", "ph")
	def test_Cheorui_jangmak_rr(self):
		self.run_test("철의 장막", "{{ko-IPA|cap=y|uie=2}}", "Cheorui jangmak", "rr")
	def test_Cheorui_jangmak_rrr(self):
		self.run_test("철의 장막", "{{ko-IPA|cap=y|uie=2}}", "Cheol'ui jangmag", "rrr")
	def test_Cheorui_jangmak_mr(self):
		self.run_test("철의 장막", "{{ko-IPA|cap=y|uie=2}}", "Ch'ŏrŭi changmak", "mr")
	def test_Cheorui_jangmak_yr(self):
		self.run_test("철의 장막", "{{ko-IPA|cap=y|uie=2}}", "chel.uy cangmak", "yr")
	def test_Cheorui_jangmak_ipa(self):
		self.run_test("철의 장막", "{{ko-IPA|cap=y|uie=2}}", "[t͡ɕʰʌ̹ɾɰi t͡ɕa̠ŋma̠k̚] ~ [t͡ɕʰʌ̹ɾe̞ t͡ɕa̠ŋma̠k̚]", "ipa")

	def test_Sobieteu_sahoejuui_gonghwaguk_yeonbang_ph(self):
		self.run_test("소비에트 사회주의 공화국 연방", "{{ko-IPA|cap=y|l=11|ui=9}}", "소비에트 사훼주의 공(ː)화국 연방/소비에트 사훼주의 공(ː)화국 연방/소비에트 사회주의 공(ː)화국 연방/소비에트 사회주이 공(ː)화국 연방", "ph")
	def test_Sobieteu_sahoejuui_gonghwaguk_yeonbang_rr(self):
		self.run_test("소비에트 사회주의 공화국 연방", "{{ko-IPA|cap=y|l=11|ui=9}}", "Sobieteu sahoejuui gonghwaguk yeonbang", "rr")
	def test_Sobieteu_sahoejuui_gonghwaguk_yeonbang_rrr(self):
		self.run_test("소비에트 사회주의 공화국 연방", "{{ko-IPA|cap=y|l=11|ui=9}}", "Sobieteu sahoejuui gonghwagug yeonbang", "rrr")
	def test_Sobieteu_sahoejuui_gonghwaguk_yeonbang_mr(self):
		self.run_test("소비에트 사회주의 공화국 연방", "{{ko-IPA|cap=y|l=11|ui=9}}", "Sobiet'ŭ sahoejuŭi konghwaguk yŏnbang", "mr")
	def test_Sobieteu_sahoejuui_gonghwaguk_yeonbang_yr(self):
		self.run_test("소비에트 사회주의 공화국 연방", "{{ko-IPA|cap=y|l=11|ui=9}}", "sopiey.thu sahoycwuuy kōnghwakwuk yenpang", "yr")
	def test_Sobieteu_sahoejuui_gonghwaguk_yeonbang_ipa(self):
		self.run_test("소비에트 사회주의 공화국 연방", "{{ko-IPA|cap=y|l=11|ui=9}}", "[sʰo̞bie̞tʰɯ sʰa̠βwe̞d͡ʑuɰi ko̞(ː)ŋβwa̠ɡuk̚ jʌ̹nba̠ŋ] ~ [sʰo̞bie̞tʰɯ sʰa̠βwe̞d͡ʑuɰi ko̞(ː)ŋβwa̠ɡuk̚ jʌ̹nba̠ŋ] ~ [sʰo̞bie̞tʰɯ sʰa̠ɦø̞d͡ʑuɰi ko̞(ː)ŋβwa̠ɡuk̚ jʌ̹nba̠ŋ] ~ [sʰo̞bie̞tʰɯ sʰa̠ɦø̞d͡ʑui ko̞(ː)ŋβwa̠ɡuk̚ jʌ̹nba̠ŋ]", "ipa")

	def test_yennieung_ph(self):
		self.run_test("옛이응", "{{ko-IPA|ni=2|l=y}}", "옌(ː)니응", "ph")
	def test_yennieung_rr(self):
		self.run_test("옛이응", "{{ko-IPA|ni=2|l=y}}", "yennieung", "rr")
	def test_yennieung_rrr(self):
		self.run_test("옛이응", "{{ko-IPA|ni=2|l=y}}", "yes'ieung", "rrr")
	def test_yennieung_mr(self):
		self.run_test("옛이응", "{{ko-IPA|ni=2|l=y}}", "yenniŭng", "mr")
	def test_yennieung_yr(self):
		self.run_test("옛이응", "{{ko-IPA|ni=2|l=y}}", "yēysniung", "yr")
	def test_yennieung_ipa(self):
		self.run_test("옛이응", "{{ko-IPA|ni=2|l=y}}", "[ˈje̞(ː)nniɯŋ]", "ipa")

	def test_samyeongdangui_sacheotbang_ph(self):
		self.run_test("사명당의 사첫방", "{{ko-IPA|l=y|uie=4|nobc=7}}", "사(ː)명당의 사첟빵/사(ː)명당에 사첟빵/사(ː)명당의 사처빵/사(ː)명당에 사처빵", "ph")
	def test_samyeongdangui_sacheotbang_rr(self):
		self.run_test("사명당의 사첫방", "{{ko-IPA|l=y|uie=4|nobc=7}}", "samyeongdang'ui sacheotbang", "rr")
	def test_samyeongdangui_sacheotbang_rrr(self):
		self.run_test("사명당의 사첫방", "{{ko-IPA|l=y|uie=4|nobc=7}}", "samyeongdang'ui sacheosbang", "rrr")
	def test_samyeongdangui_sacheotbang_mr(self):
		self.run_test("사명당의 사첫방", "{{ko-IPA|l=y|uie=4|nobc=7}}", "samyŏngdangŭi sach'ŏtpang", "mr")
	def test_samyeongdangui_sacheotbang_yr(self):
		self.run_test("사명당의 사첫방", "{{ko-IPA|l=y|uie=4|nobc=7}}", "sāmyengtanguy sa.chespang", "yr")
	def test_samyeongdangui_sacheotbang_ipa(self):
		self.run_test("사명당의 사첫방", "{{ko-IPA|l=y|uie=4|nobc=7}}", "[ˈsʰa̠(ː)mjʌ̹ŋda̠ŋɰi sʰa̠t͡ɕʰʌ̹t̚p͈a̠ŋ] ~ [ˈsʰa̠(ː)mjʌ̹ŋda̠ŋe̞ sʰa̠t͡ɕʰʌ̹t̚p͈a̠ŋ] ~ [ˈsʰa̠(ː)mjʌ̹ŋda̠ŋɰi sʰa̠t͡ɕʰʌ̹p͈a̠ŋ] ~ [ˈsʰa̠(ː)mjʌ̹ŋda̠ŋe̞ sʰa̠t͡ɕʰʌ̹p͈a̠ŋ]", "ipa")

	def test_Noseuweseuteu_junju_ph(self):
		self.run_test("노스웨스트 준주", "{{ko-IPA|l=7|com=1|cap=y}}", "노쓰웨스트 준(ː)주", "ph")
	def test_Noseuweseuteu_junju_rr(self):
		self.run_test("노스웨스트 준주", "{{ko-IPA|l=7|com=1|cap=y}}", "Noseuweseuteu junju", "rr")
	def test_Noseuweseuteu_junju_rrr(self):
		self.run_test("노스웨스트 준주", "{{ko-IPA|l=7|com=1|cap=y}}", "Noseuweseuteu junju", "rrr")
	def test_Noseuweseuteu_junju_mr(self):
		self.run_test("노스웨스트 준주", "{{ko-IPA|l=7|com=1|cap=y}}", "Nossŭwesŭt'ŭ chunju", "mr")
	def test_Noseuweseuteu_junju_yr(self):
		self.run_test("노스웨스트 준주", "{{ko-IPA|l=7|com=1|cap=y}}", "noqsuweysu.thu cwūn.cwu", "yr")
	def test_Noseuweseuteu_junju_ipa(self):
		self.run_test("노스웨스트 준주", "{{ko-IPA|l=7|com=1|cap=y}}", "[no̞s͈ɯwe̞sʰɯtʰɯ t͡ɕu(ː)ɲd͡ʑu]", "ipa")

	def test_bansinbanui_ph(self):
		self.run_test("반신반의", "{{ko-IPA|l=1,3|ui=4}}", "반(ː)신바(ː)늬/반(ː)신바(ː)니", "ph")
	def test_bansinbanui_rr(self):
		self.run_test("반신반의", "{{ko-IPA|l=1,3|ui=4}}", "bansinbanui", "rr")
	def test_bansinbanui_rrr(self):
		self.run_test("반신반의", "{{ko-IPA|l=1,3|ui=4}}", "bansinban'ui", "rrr")
	def test_bansinbanui_mr(self):
		self.run_test("반신반의", "{{ko-IPA|l=1,3|ui=4}}", "pansinbanŭi", "mr")
	def test_bansinbanui_yr(self):
		self.run_test("반신반의", "{{ko-IPA|l=1,3|ui=4}}", "pānsinpān.uy", "yr")
	...
	def test_gwigatgil_rr(self):
		self.run_test("귀갓길", "{{ko-IPA|com=2|l=y|nobc=2}}", "gwigatgil", "rr")
	def test_gwigatgil_rrr(self):
		self.run_test("귀갓길", "{{ko-IPA|com=2|l=y|nobc=2}}", "gwigasgil", "rrr")
	def test_gwigatgil_mr(self):
		self.run_test("귀갓길", "{{ko-IPA|com=2|l=y|nobc=2}}", "kwigatkil", "mr")
	def test_gwigatgil_yr(self):
		self.run_test("귀갓길", "{{ko-IPA|com=2|l=y|nobc=2}}", "kwīkasqkil", "yr")
	def test_gwigatgil_ipa(self):
		self.run_test("귀갓길", "{{ko-IPA|com=2|l=y|nobc=2}}", "[ˈkɥi(ː)ɡa̠t̚k͈iɭ] ~ [ˈkɥi(ː)ɡa̠k͈iɭ] ~ [ˈky(ː)ɡa̠t̚k͈iɭ] ~ [ˈky(ː)ɡa̠k͈iɭ]", "ipa")

	def test_hagyotgil_ph(self):
		self.run_test("하굣길", "{{ko-IPA|nobc=2|l=y}}", "하(ː)굗낄/하(ː)교낄", "ph")
	def test_hagyotgil_rr(self):
		self.run_test("하굣길", "{{ko-IPA|nobc=2|l=y}}", "hagyotgil", "rr")
	def test_hagyotgil_rrr(self):
		self.run_test("하굣길", "{{ko-IPA|nobc=2|l=y}}", "hagyosgil", "rrr")
	def test_hagyotgil_mr(self):
		self.run_test("하굣길", "{{ko-IPA|nobc=2|l=y}}", "hagyotkil", "mr")
	def test_hagyotgil_yr(self):
		self.run_test("하굣길", "{{ko-IPA|nobc=2|l=y}}", "hākyoskil", "yr")
	def test_hagyotgil_ipa(self):
		self.run_test("하굣길", "{{ko-IPA|nobc=2|l=y}}", "[ˈha̠(ː)ɡjot̚k͈iɭ] ~ [ˈha̠(ː)ɡjok͈iɭ]", "ipa")

	def test_Yeongnyeonbang_ph(self):
		self.run_test("영연방", "{{ko-IPA|cap=y|ni=2}}", "영년방", "ph")
	def test_Yeongnyeonbang_rr(self):
		self.run_test("영연방", "{{ko-IPA|cap=y|ni=2}}", "Yeongnyeonbang", "rr")
	def test_Yeongnyeonbang_rrr(self):
		self.run_test("영연방", "{{ko-IPA|cap=y|ni=2}}", "Yeong'yeonbang", "rrr")
	def test_Yeongnyeonbang_mr(self):
		self.run_test("영연방", "{{ko-IPA|cap=y|ni=2}}", "Yŏngnyŏnbang", "mr")
	def test_Yeongnyeonbang_yr(self):
		self.run_test("영연방", "{{ko-IPA|cap=y|ni=2}}", "yengnyenpang", "yr")
	def test_Yeongnyeonbang_ipa(self):
		self.run_test("영연방", "{{ko-IPA|cap=y|ni=2}}", "[jʌ̹ŋɲʌ̹nba̠ŋ]", "ipa")

	def test_samga_goinui_myeongbogeul_bimnida_ph(self):
		self.run_test("삼가 고인의 명복을 빕니다", "{{ko-IPA|l=4,12|uie=6}}", "삼가 고(ː)이늬 명보글 빔(ː)니다/삼가 고(ː)이네 명보글 빔(ː)니다", "ph")
	def test_samga_goinui_myeongbogeul_bimnida_rr(self):
		self.run_test("삼가 고인의 명복을 빕니다", "{{ko-IPA|l=4,12|uie=6}}", "samga goinui myeongbogeul bimnida", "rr")
	def test_samga_goinui_myeongbogeul_bimnida_rrr(self):
		self.run_test("삼가 고인의 명복을 빕니다", "{{ko-IPA|l=4,12|uie=6}}", "samga goin'ui myeongbog'eul bibnida", "rrr")
	def test_samga_goinui_myeongbogeul_bimnida_mr(self):
		self.run_test("삼가 고인의 명복을 빕니다", "{{ko-IPA|l=4,12|uie=6}}", "samga koinŭi myŏngbogŭl pimnida", "mr")
	def test_samga_goinui_myeongbogeul_bimnida_yr(self):
		self.run_test("삼가 고인의 명복을 빕니다", "{{ko-IPA|l=4,12|uie=6}}", "samka kōin.uy myengpok.ul pīpnita", "yr")
	def test_samga_goinui_myeongbogeul_bimnida_ipa(self):
		self.run_test("삼가 고인의 명복을 빕니다", "{{ko-IPA|l=4,12|uie=6}}", "[sʰa̠mɡa̠ ko̞(ː)inɰi mjʌ̹ŋbo̞ɡɯɭ pi(ː)mnida̠] ~ [sʰa̠mɡa̠ ko̞(ː)ine̞ mjʌ̹ŋbo̞ɡɯɭ pi(ː)mnida̠]", "ipa")

	def test_jeomjeomjeom_ph(self):
		self.run_test("점점점", "{{ko-IPA|com=0,1,2}}", "쩜쩜쩜", "ph")
	def test_jeomjeomjeom_rr(self):
		self.run_test("점점점", "{{ko-IPA|com=0,1,2}}", "jeomjeomjeom", "rr")
	def test_jeomjeomjeom_rrr(self):
		self.run_test("점점점", "{{ko-IPA|com=0,1,2}}", "jeomjeomjeom", "rrr")
	def test_jeomjeomjeom_mr(self):
		self.run_test("점점점", "{{ko-IPA|com=0,1,2}}", "chŏmchŏmchŏm", "mr")
	def test_jeomjeomjeom_yr(self):
		self.run_test("점점점", "{{ko-IPA|com=0,1,2}}", "qcemqcemqcem", "yr")
	def test_jeomjeomjeom_ipa(self):
		self.run_test("점점점", "{{ko-IPA|com=0,1,2}}", "[t͡ɕ͈ʌ̹mt͡ɕ͈ʌ̹mt͡ɕ͈ʌ̹m]", "ipa")

	def test_Hwaiteuhoseu_ph(self):
		self.run_test("화이트호스", "{{ko-IPA|com=4|cap=y}}", "화이트호쓰", "ph")
	def test_Hwaiteuhoseu_rr(self):
		self.run_test("화이트호스", "{{ko-IPA|com=4|cap=y}}", "Hwaiteuhoseu", "rr")
	def test_Hwaiteuhoseu_rrr(self):
		self.run_test("화이트호스", "{{ko-IPA|com=4|cap=y}}", "Hwaiteuhoseu", "rrr")
	def test_Hwaiteuhoseu_mr(self):
		self.run_test("화이트호스", "{{ko-IPA|com=4|cap=y}}", "Hwait'ŭhossŭ", "mr")
	def test_Hwaiteuhoseu_yr(self):
		self.run_test("화이트호스", "{{ko-IPA|com=4|cap=y}}", "hwai.thuhoqsu", "yr")
	...
	def test_hando_kkeutdo_eopda_rr(self):
		self.run_test("한도 끝도 없다", "{{ko-IPA|l=1,7}}", "hando kkeutdo eopda", "rr")
	def test_hando_kkeutdo_eopda_rrr(self):
		self.run_test("한도 끝도 없다", "{{ko-IPA|l=1,7}}", "hando kkeutdo eobsda", "rrr")
	def test_hando_kkeutdo_eopda_mr(self):
		self.run_test("한도 끝도 없다", "{{ko-IPA|l=1,7}}", "hando kkŭtto ŏpta", "mr")
	def test_hando_kkeutdo_eopda_yr(self):
		self.run_test("한도 끝도 없다", "{{ko-IPA|l=1,7}}", "hānto kkuthto ēpsta", "yr")
	def test_hando_kkeutdo_eopda_ipa(self):
		self.run_test("한도 끝도 없다", "{{ko-IPA|l=1,7}}", "[ˈha̠(ː)ndo̞ k͈ɯt̚t͈o̞ ɘ(ː)p̚t͈a̠]", "ipa")

	def test_Gangwondo_posu_ph(self):
		self.run_test("강원도 포수", "{{ko-IPA|l=5|cap=y}}", "강원도 포(ː)수", "ph")
	def test_Gangwondo_posu_rr(self):
		self.run_test("강원도 포수", "{{ko-IPA|l=5|cap=y}}", "Gang'wondo posu", "rr")
	def test_Gangwondo_posu_rrr(self):
		self.run_test("강원도 포수", "{{ko-IPA|l=5|cap=y}}", "Gang'wondo posu", "rrr")
	def test_Gangwondo_posu_mr(self):
		self.run_test("강원도 포수", "{{ko-IPA|l=5|cap=y}}", "Kangwŏndo p'osu", "mr")
	def test_Gangwondo_posu_yr(self):
		self.run_test("강원도 포수", "{{ko-IPA|l=5|cap=y}}", "kangwento phōswu", "yr")
	def test_Gangwondo_posu_ipa(self):
		self.run_test("강원도 포수", "{{ko-IPA|l=5|cap=y}}", "[ka̠ŋwʌ̹ndo̞ pʰo̞(ː)sʰu]", "ipa")

	def test_horangineun_jugeoseo_gajugeul_namgigo_sarameun_jugeoseo_ireumeul_namginda_ph(self):
		self.run_test("호랑이는 죽어서 가죽을 남기고 사람은 죽어서 이름을 남긴다", "{{ko-IPA|l=1,14,18}}", "호(ː)랑이는 주거서 가주글 남(ː)기고 사(ː)라믄 주거서 이르믈 남긴다", "ph")
	def test_horangineun_jugeoseo_gajugeul_namgigo_sarameun_jugeoseo_ireumeul_namginda_rr(self):
		self.run_test("호랑이는 죽어서 가죽을 남기고 사람은 죽어서 이름을 남긴다", "{{ko-IPA|l=1,14,18}}", "horang'ineun jugeoseo gajugeul namgigo sarameun jugeoseo ireumeul namginda", "rr")
	def test_horangineun_jugeoseo_gajugeul_namgigo_sarameun_jugeoseo_ireumeul_namginda_rrr(self):
		self.run_test("호랑이는 죽어서 가죽을 남기고 사람은 죽어서 이름을 남긴다", "{{ko-IPA|l=1,14,18}}", "holang'ineun jug'eoseo gajug'eul namgigo salam'eun jug'eoseo ileum'eul namginda", "rrr")
	def test_horangineun_jugeoseo_gajugeul_namgigo_sarameun_jugeoseo_ireumeul_namginda_mr(self):
		self.run_test("호랑이는 죽어서 가죽을 남기고 사람은 죽어서 이름을 남긴다", "{{ko-IPA|l=1,14,18}}", "horanginŭn chugŏsŏ kajugŭl namgigo saramŭn chugŏsŏ irŭmŭl namginda", "mr")
	def test_horangineun_jugeoseo_gajugeul_namgigo_sarameun_jugeoseo_ireumeul_namginda_yr(self):
		self.run_test("호랑이는 죽어서 가죽을 남기고 사람은 죽어서 이름을 남긴다", "{{ko-IPA|l=1,14,18}}", "hōlanginun cwuk.ese kacwuk.ul nāmkiko sālam.un cwuk.ese ilum.ul namkinta", "yr")
	def test_horangineun_jugeoseo_gajugeul_namgigo_sarameun_jugeoseo_ireumeul_namginda_ipa(self):
		self.run_test("호랑이는 죽어서 가죽을 남기고 사람은 죽어서 이름을 남긴다", "{{ko-IPA|l=1,14,18}}", "[ˈɸʷo̞(ː)ɾa̠ŋinɯn t͡ɕuɡʌ̹sʰʌ̹ ka̠d͡ʑuɡɯɭ na̠(ː)mɡiɡo̞ sʰa̠(ː)ɾa̠mɯn t͡ɕuɡʌ̹sʰʌ̹ iɾɯmɯɭ na̠mɡinda̠]", "ipa")

	def test_geupjinjeok_yeoseongjuui_ph(self):
		self.run_test("급진적 여성주의", "{{ko-IPA|ui=8}}", "급찐적 여성주의/급찐적 여성주이", "ph")
	def test_geupjinjeok_yeoseongjuui_rr(self):
		self.run_test("급진적 여성주의", "{{ko-IPA|ui=8}}", "geupjinjeok yeoseongjuui", "rr")
	def test_geupjinjeok_yeoseongjuui_rrr(self):
		self.run_test("급진적 여성주의", "{{ko-IPA|ui=8}}", "geubjinjeog yeoseongjuui", "rrr")
	def test_geupjinjeok_yeoseongjuui_mr(self):
		self.run_test("급진적 여성주의", "{{ko-IPA|ui=8}}", "kŭpchinjŏk yŏsŏngjuŭi", "mr")
	def test_geupjinjeok_yeoseongjuui_yr(self):
		self.run_test("급진적 여성주의", "{{ko-IPA|ui=8}}", "kupcin.cek yesengcwuuy", "yr")
	def test_geupjinjeok_yeoseongjuui_ipa(self):
		self.run_test("급진적 여성주의", "{{ko-IPA|ui=8}}", "[kɯp̚t͡ɕ͈iɲd͡ʑʌ̹k̚ jʌ̹sʰʌ̹ŋd͡ʑuɰi] ~ [kɯp̚t͡ɕ͈iɲd͡ʑʌ̹k̚ jʌ̹sʰʌ̹ŋd͡ʑui]", "ipa")

	def test_gungihullyeon_ph(self):
		self.run_test("군기훈련", "{{ko-IPA|l=3}}", "군기훌(ː)련", "ph")
	def test_gungihullyeon_rr(self):
		self.run_test("군기훈련", "{{ko-IPA|l=3}}", "gun'gihullyeon", "rr")
	def test_gungihullyeon_rrr(self):
		self.run_test("군기훈련", "{{ko-IPA|l=3}}", "gungihunlyeon", "rrr")
	def test_gungihullyeon_mr(self):
		self.run_test("군기훈련", "{{ko-IPA|l=3}}", "kun'gihullyŏn", "mr")
	def test_gungihullyeon_yr(self):
		self.run_test("군기훈련", "{{ko-IPA|l=3}}", "kwunkihwūnlyen", "yr")
	...
	def test_jeongsingwaui_rr(self):
		self.run_test("정신과의", "{{ko-IPA|com=2|ui=4}}", "jeongsin'gwaui", "rr")
	def test_jeongsingwaui_rrr(self):
		self.run_test("정신과의", "{{ko-IPA|com=2|ui=4}}", "jeongsingwaui", "rrr")
	def test_jeongsingwaui_mr(self):
		self.run_test("정신과의", "{{ko-IPA|com=2|ui=4}}", "chŏngsinkwaŭi", "mr")
	def test_jeongsingwaui_yr(self):
		self.run_test("정신과의", "{{ko-IPA|com=2|ui=4}}", "cengsinqkwauy", "yr")
	def test_jeongsingwaui_ipa(self):
		self.run_test("정신과의", "{{ko-IPA|com=2|ui=4}}", "[t͡ɕʌ̹ŋɕʰink͈wa̠ɰi] ~ [t͡ɕʌ̹ŋɕʰink͈wa̠i]", "ipa")

	def test_jeoui_ph(self):
		self.run_test("저의", "{{ko-IPA|uie=2}}", "저의/저에", "ph")
	def test_jeoui_rr(self):
		self.run_test("저의", "{{ko-IPA|uie=2}}", "jeoui", "rr")
	def test_jeoui_rrr(self):
		self.run_test("저의", "{{ko-IPA|uie=2}}", "jeoui", "rrr")
	def test_jeoui_mr(self):
		self.run_test("저의", "{{ko-IPA|uie=2}}", "chŏŭi", "mr")
	def test_jeoui_yr(self):
		self.run_test("저의", "{{ko-IPA|uie=2}}", "ceuy", "yr")
	...
	def test_jeongjeom_rr(self):
		self.run_test("정점", "{{ko-IPA|l=n|com=1}}", "jeongjeom", "rr")
	def test_jeongjeom_rrr(self):
		self.run_test("정점", "{{ko-IPA|l=n|com=1}}", "jeongjeom", "rrr")
	def test_jeongjeom_mr(self):
		self.run_test("정점", "{{ko-IPA|l=n|com=1}}", "chŏngchŏm", "mr")
	def test_jeongjeom_yr(self):
		self.run_test("정점", "{{ko-IPA|l=n|com=1}}", "cengqcem", "yr")
	def test_jeongjeom_ipa(self):
		self.run_test("정점", "{{ko-IPA|l=n|com=1}}", "[t͡ɕʌ̹ŋt͡ɕ͈ʌ̹m]", "ipa")

	def test_torandae_ph(self):
		self.run_test("토란대", "{{ko-IPA|l=n|com=2}}", "토란때/토란떼", "ph")
	def test_torandae_rr(self):
		self.run_test("토란대", "{{ko-IPA|l=n|com=2}}", "torandae", "rr")
	def test_torandae_rrr(self):
		self.run_test("토란대", "{{ko-IPA|l=n|com=2}}", "tolandae", "rrr")
	def test_torandae_mr(self):
		self.run_test("토란대", "{{ko-IPA|l=n|com=2}}", "t'orantae", "mr")
	def test_torandae_yr(self):
		self.run_test("토란대", "{{ko-IPA|l=n|com=2}}", "tholanqtay", "yr")
	def test_torandae_ipa(self):
		self.run_test("토란대", "{{ko-IPA|l=n|com=2}}", "[tʰo̞ɾa̠nt͈ɛ] ~ [tʰo̞ɾa̠nt͈e̞]", "ipa")

	def test_gayatgo_ph(self):
		self.run_test("가얏고", "{{ko-IPA|l=n|nobc=2}}", "가얃꼬/가야꼬", "ph")
	def test_gayatgo_rr(self):
		self.run_test("가얏고", "{{ko-IPA|l=n|nobc=2}}", "gayatgo", "rr")
	def test_gayatgo_rrr(self):
		self.run_test("가얏고", "{{ko-IPA|l=n|nobc=2}}", "gayasgo", "rrr")
	def test_gayatgo_mr(self):
		self.run_test("가얏고", "{{ko-IPA|l=n|nobc=2}}", "kayatko", "mr")
	def test_gayatgo_yr(self):
		self.run_test("가얏고", "{{ko-IPA|l=n|nobc=2}}", "ka.yasko", "yr")
	def test_gayatgo_ipa(self):
		self.run_test("가얏고", "{{ko-IPA|l=n|nobc=2}}", "[ka̠ja̠t̚k͈o̞] ~ [ka̠ja̠k͈o̞]", "ipa")

	def test_Guyugoseullabia_makedonia_gonghwaguk_ph(self):
		self.run_test("구유고슬라비아 마케도니아 공화국", "{{ko-IPA|cap=y|l=1,15}}", "구(ː)유고슬라비아 마케도니아 공(ː)화국", "ph")
	def test_Guyugoseullabia_makedonia_gonghwaguk_rr(self):
		self.run_test("구유고슬라비아 마케도니아 공화국", "{{ko-IPA|cap=y|l=1,15}}", "Guyugoseullabia makedonia gonghwaguk", "rr")
	def test_Guyugoseullabia_makedonia_gonghwaguk_rrr(self):
		self.run_test("구유고슬라비아 마케도니아 공화국", "{{ko-IPA|cap=y|l=1,15}}", "Guyugoseullabia makedonia gonghwagug", "rrr")
	def test_Guyugoseullabia_makedonia_gonghwaguk_mr(self):
		self.run_test("구유고슬라비아 마케도니아 공화국", "{{ko-IPA|cap=y|l=1,15}}", "Kuyugosŭllabia mak'edonia konghwaguk", "mr")
	def test_Guyugoseullabia_makedonia_gonghwaguk_yr(self):
		self.run_test("구유고슬라비아 마케도니아 공화국", "{{ko-IPA|cap=y|l=1,15}}", "kwū.yukosullapia ma.kheytonia kōnghwakwuk", "yr")
	def test_Guyugoseullabia_makedonia_gonghwaguk_ipa(self):
		self.run_test("구유고슬라비아 마케도니아 공화국", "{{ko-IPA|cap=y|l=1,15}}", "[ˈku(ː)juɡo̞sʰɯɭɭa̠bia̠ ma̠kʰe̞do̞nia̠ ko̞(ː)ŋβwa̠ɡuk̚]", "ipa")

	def test_banjiseongjuui_ph(self):
		self.run_test("반지성주의", "{{ko-IPA|l=y|ui=5}}", "반(ː)지성주의/반(ː)지성주이", "ph")
	def test_banjiseongjuui_rr(self):
		self.run_test("반지성주의", "{{ko-IPA|l=y|ui=5}}", "banjiseongjuui", "rr")
	def test_banjiseongjuui_rrr(self):
		self.run_test("반지성주의", "{{ko-IPA|l=y|ui=5}}", "banjiseongjuui", "rrr")
	def test_banjiseongjuui_mr(self):
		self.run_test("반지성주의", "{{ko-IPA|l=y|ui=5}}", "panjisŏngjuŭi", "mr")
	def test_banjiseongjuui_yr(self):
		self.run_test("반지성주의", "{{ko-IPA|l=y|ui=5}}", "pān.cisengcwuuy", "yr")
	...
	def test_pyouimunja_rr(self):
		self.run_test("표의문자", "{{ko-IPA|ui=2|com=3}}", "pyouimunja", "rr")
	def test_pyouimunja_rrr(self):
		self.run_test("표의문자", "{{ko-IPA|ui=2|com=3}}", "pyouimunja", "rrr")
	def test_pyouimunja_mr(self):
		self.run_test("표의문자", "{{ko-IPA|ui=2|com=3}}", "p'yoŭimuncha", "mr")
	def test_pyouimunja_yr(self):
		self.run_test("표의문자", "{{ko-IPA|ui=2|com=3}}", "phyouymunqca", "yr")
	def test_pyouimunja_ipa(self):
		self.run_test("표의문자", "{{ko-IPA|ui=2|com=3}}", "[pʰjoɰimuɲt͡ɕ͈a̠] ~ [pʰjoimuɲt͡ɕ͈a̠]", "ipa")

	def test_Geumgangsan_ph(self):
		self.run_test("금강산", "{{ko-IPA|l=n|cap=y}}", "금강산", "ph")
	def test_Geumgangsan_rr(self):
		self.run_test("금강산", "{{ko-IPA|l=n|cap=y}}", "Geumgangsan", "rr")
	def test_Geumgangsan_rrr(self):
		self.run_test("금강산", "{{ko-IPA|l=n|cap=y}}", "Geumgangsan", "rrr")
	def test_Geumgangsan_mr(self):
		self.run_test("금강산", "{{ko-IPA|l=n|cap=y}}", "Kŭmgangsan", "mr")
	def test_Geumgangsan_yr(self):
		self.run_test("금강산", "{{ko-IPA|l=n|cap=y}}", "kumkangsan", "yr")
	def test_Geumgangsan_ipa(self):
		self.run_test("금강산", "{{ko-IPA|l=n|cap=y}}", "[kɯmɡa̠ŋsʰa̠n]", "ipa")

	def test_sageonui_jipyeongseon_ph(self):
		self.run_test("사건의 지평선", "{{ko-IPA|l=y|com=1|uie=3}}", "사(ː)꺼늬 지평선/사(ː)꺼네 지평선", "ph")
	def test_sageonui_jipyeongseon_rr(self):
		self.run_test("사건의 지평선", "{{ko-IPA|l=y|com=1|uie=3}}", "sageonui jipyeongseon", "rr")
	def test_sageonui_jipyeongseon_rrr(self):
		self.run_test("사건의 지평선", "{{ko-IPA|l=y|com=1|uie=3}}", "sageon'ui jipyeongseon", "rrr")
	def test_sageonui_jipyeongseon_mr(self):
		self.run_test("사건의 지평선", "{{ko-IPA|l=y|com=1|uie=3}}", "sakŏnŭi chip'yŏngsŏn", "mr")
	def test_sageonui_jipyeongseon_yr(self):
		self.run_test("사건의 지평선", "{{ko-IPA|l=y|com=1|uie=3}}", "sāqken.uy ci.phyengsen", "yr")
	def test_sageonui_jipyeongseon_ipa(self):
		self.run_test("사건의 지평선", "{{ko-IPA|l=y|com=1|uie=3}}", "[ˈsʰa̠(ː)k͈ʌ̹nɰi t͡ɕipʰjʌ̹ŋsʰʌ̹n] ~ [ˈsʰa̠(ː)k͈ʌ̹ne̞ t͡ɕipʰjʌ̹ŋsʰʌ̹n]", "ipa")

	def test_duppulkoppulso_ph(self):
		self.run_test("두뿔코뿔소", "{{ko-IPA|l=y|com=4}}", "두(ː)뿔코뿔쏘", "ph")
	def test_duppulkoppulso_rr(self):
		self.run_test("두뿔코뿔소", "{{ko-IPA|l=y|com=4}}", "duppulkoppulso", "rr")
	def test_duppulkoppulso_rrr(self):
		self.run_test("두뿔코뿔소", "{{ko-IPA|l=y|com=4}}", "du'ppulko'ppulso", "rrr")
	def test_duppulkoppulso_mr(self):
		self.run_test("두뿔코뿔소", "{{ko-IPA|l=y|com=4}}", "tuppulk'oppulsso", "mr")
	def test_duppulkoppulso_yr(self):
		self.run_test("두뿔코뿔소", "{{ko-IPA|l=y|com=4}}", "twū.ppul.kho.ppulqso", "yr")
	def test_duppulkoppulso_ipa(self):
		self.run_test("두뿔코뿔소", "{{ko-IPA|l=y|com=4}}", "[ˈtu(ː)p͈uɭkʰo̞p͈uɭs͈o̞]", "ipa")

	def test_Apeurikaui_ppul_ph(self):
		self.run_test("아프리카의 뿔", "{{ko-IPA|uie=5|cap=y}}", "아프리카의 뿔/아프리카에 뿔", "ph")
	def test_Apeurikaui_ppul_rr(self):
		self.run_test("아프리카의 뿔", "{{ko-IPA|uie=5|cap=y}}", "Apeurikaui ppul", "rr")
	def test_Apeurikaui_ppul_rrr(self):
		self.run_test("아프리카의 뿔", "{{ko-IPA|uie=5|cap=y}}", "Apeulikaui ppul", "rrr")
	def test_Apeurikaui_ppul_mr(self):
		self.run_test("아프리카의 뿔", "{{ko-IPA|uie=5|cap=y}}", "Ap'ŭrik'aŭi ppul", "mr")
	def test_Apeurikaui_ppul_yr(self):
		self.run_test("아프리카의 뿔", "{{ko-IPA|uie=5|cap=y}}", "a.phuli.khauy ppul", "yr")
	def test_Apeurikaui_ppul_ipa(self):
		self.run_test("아프리카의 뿔", "{{ko-IPA|uie=5|cap=y}}", "[a̠pʰɯɾikʰa̠ɰi p͈uɭ] ~ [a̠pʰɯɾikʰa̠e̞ p͈uɭ]", "ipa")

	def test_gollibwonchuri_ph(self):
		self.run_test("골잎원추리", "{{ko-IPA|ni=2|bcred=2}}", "골리붠추리", "ph")
	def test_gollibwonchuri_rr(self):
		self.run_test("골잎원추리", "{{ko-IPA|ni=2|bcred=2}}", "gollibwonchuri", "rr")
	def test_gollibwonchuri_rrr(self):
		self.run_test("골잎원추리", "{{ko-IPA|ni=2|bcred=2}}", "gol'ip'wonchuli", "rrr")
	def test_gollibwonchuri_mr(self):
		self.run_test("골잎원추리", "{{ko-IPA|ni=2|bcred=2}}", "kollibwŏnch'uri", "mr")
	def test_gollibwonchuri_yr(self):
		self.run_test("골잎원추리", "{{ko-IPA|ni=2|bcred=2}}", "kolliph.wen.chwuli", "yr")
	def test_gollibwonchuri_ipa(self):
		self.run_test("골잎원추리", "{{ko-IPA|ni=2|bcred=2}}", "[ko̞ʎʎibwʌ̹ɲt͡ɕʰuɾi]", "ipa")

	def test_nambuk_ph(self):
		self.run_test("남북", "{{ko-IPA|cap=n}}", "남북", "ph")
	def test_nambuk_rr(self):
		self.run_test("남북", "{{ko-IPA|cap=n}}", "nambuk", "rr")
	def test_nambuk_rrr(self):
		self.run_test("남북", "{{ko-IPA|cap=n}}", "nambug", "rrr")
	def test_nambuk_mr(self):
		self.run_test("남북", "{{ko-IPA|cap=n}}", "nambuk", "mr")
	def test_nambuk_yr(self):
		self.run_test("남북", "{{ko-IPA|cap=n}}", "nampuk", "yr")
	def test_nambuk_ipa(self):
		self.run_test("남북", "{{ko-IPA|cap=n}}", "[na̠mbuk̚]", "ipa")

	def test_Deinno_ph(self):
		self.run_test("데인로", "{{ko-IPA|cap=y|nn=3}}", "데인노", "ph")
	def test_Deinno_rr(self):
		self.run_test("데인로", "{{ko-IPA|cap=y|nn=3}}", "Deinno", "rr")
	def test_Deinno_rrr(self):
		self.run_test("데인로", "{{ko-IPA|cap=y|nn=3}}", "Deinlo", "rrr")
	def test_Deinno_mr(self):
		self.run_test("데인로", "{{ko-IPA|cap=y|nn=3}}", "Teinno", "mr")
	def test_Deinno_yr(self):
		self.run_test("데인로", "{{ko-IPA|cap=y|nn=3}}", "teyinlo", "yr")
	...
	def test_jeoneun_hanguk_saramieyo_rr(self):
		self.run_test("저는 한국 사람이에요", "{{ko-IPA|l=4,7}}", "jeoneun han'guk saramieyo", "rr")
	def test_jeoneun_hanguk_saramieyo_rrr(self):
		self.run_test("저는 한국 사람이에요", "{{ko-IPA|l=4,7}}", "jeoneun hangug salam'ieyo", "rrr")
	def test_jeoneun_hanguk_saramieyo_mr(self):
		self.run_test("저는 한국 사람이에요", "{{ko-IPA|l=4,7}}", "chŏnŭn han'guk saramieyo", "mr")
	def test_jeoneun_hanguk_saramieyo_yr(self):
		self.run_test("저는 한국 사람이에요", "{{ko-IPA|l=4,7}}", "cenun hānkwuk sālam.ieyyo", "yr")
	def test_jeoneun_hanguk_saramieyo_ipa(self):
		self.run_test("저는 한국 사람이에요", "{{ko-IPA|l=4,7}}", "[t͡ɕʌ̹nɯn ha̠(ː)nɡuk̚ sʰa̠(ː)ɾa̠mie̞jo]", "ipa")

	def test_tupiseu_ph(self):
		self.run_test("투피스", "{{ko-IPA|l=1,2}}", "투(ː)피(ː)스", "ph")
	def test_tupiseu_rr(self):
		self.run_test("투피스", "{{ko-IPA|l=1,2}}", "tupiseu", "rr")
	def test_tupiseu_rrr(self):
		self.run_test("투피스", "{{ko-IPA|l=1,2}}", "tupiseu", "rrr")
	def test_tupiseu_mr(self):
		self.run_test("투피스", "{{ko-IPA|l=1,2}}", "t'up'isŭ", "mr")
	def test_tupiseu_yr(self):
		self.run_test("투피스", "{{ko-IPA|l=1,2}}", "thwū.phīsu", "yr")
	def test_tupiseu_ipa(self):
		self.run_test("투피스", "{{ko-IPA|l=1,2}}", "[ˈtʰu(ː)pʰi(ː)sʰɯ]", "ipa")

	def test_ijo_ph(self):
		self.run_test("이조", "{{ko-IPA|l=1|com=1}}", "이(ː)쪼", "ph")
	def test_ijo_rr(self):
		self.run_test("이조", "{{ko-IPA|l=1|com=1}}", "ijo", "rr")
	def test_ijo_rrr(self):
		self.run_test("이조", "{{ko-IPA|l=1|com=1}}", "ijo", "rrr")
	def test_ijo_mr(self):
		self.run_test("이조", "{{ko-IPA|l=1|com=1}}", "icho", "mr")
	def test_ijo_yr(self):
		self.run_test("이조", "{{ko-IPA|l=1|com=1}}", "īqco", "yr")
	def test_ijo_ipa(self):
		self.run_test("이조", "{{ko-IPA|l=1|com=1}}", "[ˈi(ː)t͡ɕ͈o̞]", "ipa")

	def test_sonagineun_pihaneun_ge_sangchaek_ph(self):
		self.run_test("소나기는 피하는 게 상책", "{{ko-IPA|l=6,12}}", "소나기는 피(ː)하는 게 상(ː)책/소나기는 피(ː)하는 게 상(ː)첵", "ph")
	def test_sonagineun_pihaneun_ge_sangchaek_rr(self):
		self.run_test("소나기는 피하는 게 상책", "{{ko-IPA|l=6,12}}", "sonagineun pihaneun ge sangchaek", "rr")
	def test_sonagineun_pihaneun_ge_sangchaek_rrr(self):
		self.run_test("소나기는 피하는 게 상책", "{{ko-IPA|l=6,12}}", "sonagineun pihaneun ge sangchaeg", "rrr")
	def test_sonagineun_pihaneun_ge_sangchaek_mr(self):
		self.run_test("소나기는 피하는 게 상책", "{{ko-IPA|l=6,12}}", "sonaginŭn p'ihanŭn ke sangch'aek", "mr")
	def test_sonagineun_pihaneun_ge_sangchaek_yr(self):
		self.run_test("소나기는 피하는 게 상책", "{{ko-IPA|l=6,12}}", "sonakinun phīhanun key sāngchayk", "yr")
	def test_sonagineun_pihaneun_ge_sangchaek_ipa(self):
		self.run_test("소나기는 피하는 게 상책", "{{ko-IPA|l=6,12}}", "[sʰo̞na̠ɡinɯn pʰi(ː)ɦa̠nɯn ke̞ sʰa̠(ː)ŋt͡ɕʰɛk̚] ~ [sʰo̞na̠ɡinɯn pʰi(ː)ɦa̠nɯn ke̞ sʰa̠(ː)ŋt͡ɕʰe̞k̚]", "ipa")

	def test_kareul_ppobasseumyeon_murado_sseoreora_ph(self):
		self.run_test("칼을 뽑았으면 무라도 썰어라", "{{ko-IPA|l=9}}", "카를 뽀바쓰면 무(ː)라도 써러라", "ph")
	def test_kareul_ppobasseumyeon_murado_sseoreora_rr(self):
		self.run_test("칼을 뽑았으면 무라도 썰어라", "{{ko-IPA|l=9}}", "kareul ppobasseumyeon murado sseoreora", "rr")
	def test_kareul_ppobasseumyeon_murado_sseoreora_rrr(self):
		self.run_test("칼을 뽑았으면 무라도 썰어라", "{{ko-IPA|l=9}}", "kal'eul ppob'ass'eumyeon mulado sseol'eola", "rrr")
	def test_kareul_ppobasseumyeon_murado_sseoreora_mr(self):
		self.run_test("칼을 뽑았으면 무라도 썰어라", "{{ko-IPA|l=9}}", "k'arŭl ppobassŭmyŏn murado ssŏrŏra", "mr")
	def test_kareul_ppobasseumyeon_murado_sseoreora_yr(self):
		self.run_test("칼을 뽑았으면 무라도 썰어라", "{{ko-IPA|l=9}}", "khal.ul ppop.ass.umyen mūlato ssel.ela", "yr")
	def test_kareul_ppobasseumyeon_murado_sseoreora_ipa(self):
		self.run_test("칼을 뽑았으면 무라도 썰어라", "{{ko-IPA|l=9}}", "[kʰa̠ɾɯɭ p͈o̞ba̠s͈ɯmjʌ̹n mu(ː)ɾa̠do̞ s͈ʌ̹ɾʌ̹ɾa̠]", "ipa")

	def test_yagu_dongnyeongsang_ph(self):
		self.run_test("야구 동영상", "{{ko-IPA|l=1,4|ni=5}}", "야(ː)구 동(ː)녕상", "ph")
	def test_yagu_dongnyeongsang_rr(self):
		self.run_test("야구 동영상", "{{ko-IPA|l=1,4|ni=5}}", "yagu dongnyeongsang", "rr")
	def test_yagu_dongnyeongsang_rrr(self):
		self.run_test("야구 동영상", "{{ko-IPA|l=1,4|ni=5}}", "yagu dong'yeongsang", "rrr")
	def test_yagu_dongnyeongsang_mr(self):
		self.run_test("야구 동영상", "{{ko-IPA|l=1,4|ni=5}}", "yagu tongnyŏngsang", "mr")
	def test_yagu_dongnyeongsang_yr(self):
		self.run_test("야구 동영상", "{{ko-IPA|l=1,4|ni=5}}", "yākwu tōngnyengsang", "yr")
